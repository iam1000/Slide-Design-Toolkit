export const DESIGNER_BEST_7 = [
  {
    name: "스타트업 테크 디자인",
    type: "Startup Tech · B2B Pitch Deck",
    colors: ["#FFFFFF", "#2563EB", "#059669"],
    cardBg:
      "linear-gradient(135deg, rgba(37,99,235,0.08), rgba(5,150,105,0.05))",
    numBg: "rgba(37,99,235,0.10)",
    numColor: "#2563EB",
    prompt: `[NotebookLM Slide Design Guide]

Role : B2B SaaS 스타트업 대표
Industry : B2B 소프트웨어, 테크 스타트업
Type : 투자 피치덱, 사업 소개 자료

[Color Guide]
Background : 깔끔한 화이트(#FFFFFF) 또는 라이트 그레이(#F8FAFC)
Text Color : 다크 네이비(#1E293B), 서브 텍스트 미디엄 그레이(#64748B)
Accent : 프로페셔널 블루(#2563EB), 성장 그린(#059669) 지표용
Font : Inter 또는 Pretendard (Sans-serif), 제목 Bold, 본문 Regular

[Tone & Manner]
데이터 중심적이고 신뢰감 있는 톤. 투자자 관점에서 명확한 비즈니스 가치와 성장 잠재력을 강조. 간결하고 직관적인 메시지 전달.

[Image Principles]
심플한 벡터 아이콘과 깔끔한 데이터 시각화 중심. 불필요한 스톡 사진 지양. UI 스크린샷은 그림자 효과와 함께 전문적으로 표현.

[Design Characteristics]
미니멀하고 여백을 충분히 활용. 엄격한 그리드 시스템 적용. 정보 위계가 명확한 레이아웃.

[Layout Guide]
- Title Slide : 상단 좌측 로고, 중앙 메인 타이틀, 하단 우측 회사명과 날짜
- Spec Slide : 좌측 굵은 헤드라인, 우측 3-4개 핵심 포인트와 아이콘
- Comparison Slide : 2-3컬럼 비교표, 체크마크와 대시로 차별점 시각화
- CTA Slide : 중앙 집중형 콜투액션과 연락처 정보
- Tone : 전문적이고 데이터 기반
- Slide count : 7 pages
- Font size contrast : 제목 36pt / 서브제목 24pt / 본문 18pt / 캡션 14pt
- Text per slide : 30-50단어 이내, 핵심 키워드 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "전략 컨설팅 제안서",
    type: "Strategy Consulting · Proposal",
    colors: ["#FFFFFF", "#1E40AF", "#D97706"],
    cardBg:
      "linear-gradient(135deg, rgba(30,64,175,0.08), rgba(217,119,6,0.05))",
    numBg: "rgba(30,64,175,0.10)",
    numColor: "#1E40AF",
    prompt: `[NotebookLM Slide Design Guide]

Role : 전략 컨설턴트
Industry : 경영 컨설팅, 기업 전략
Type : 전략 제안서, 진단 리포트

[Color Guide]
Background : 프리미엄 화이트(#FFFFFF)
Text Color : 비즈니스 차콜(#111827), 서브 텍스트 그레이(#4B5563)
Accent : 신뢰의 네이비(#1E40AF), 포인트 골드(#D97706) 제한적 사용
Font : Helvetica Neue 또는 Apple SD Gothic Neo (깔끔한 Sans-serif)

[Tone & Manner]
논리적이고 체계적인 접근. 문제-분석-해결책-기대효과의 명확한 구조. 객관적이고 신뢰감 있는 비즈니스 언어 사용.

[Image Principles]
프레임워크 다이어그램과 2x2 매트릭스 중심. 단색 아이콘 사용. 복잡한 개념을 단순한 도형으로 시각화.

[Design Characteristics]
엄격한 정렬과 일관된 마진. 프로페셔널한 표와 그래프. 핵심 메시지가 한눈에 들어오는 구조.

[Layout Guide]
- Title Slide : 클라이언트 로고 상단, 제안서 제목 중앙, 컨설팅사 정보 하단
- Spec Slide : 핵심 이슈 좌측 정리, 우측 해결 프레임워크 다이어그램
- Comparison Slide : As-Is vs To-Be 구조, 상하 또는 좌우 분할
- CTA Slide : 로드맵 단계와 Next Step 액션 아이템
- Tone : 권위 있고 분석적
- Slide count : 7 pages
- Font size contrast : 제목 32pt / 섹션 헤드 24pt / 본문 16pt
- Text per slide : 40-70단어, 핵심 메시지 1-2줄로 명확히 구분

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "금융 투자 리포트",
    type: "Finance · Investment Report",
    colors: ["#FFFFFF", "#16A34A", "#DC2626"],
    cardBg:
      "linear-gradient(135deg, rgba(22,163,74,0.08), rgba(220,38,38,0.05))",
    numBg: "rgba(22,163,74,0.10)",
    numColor: "#16A34A",
    prompt: `[NotebookLM Slide Design Guide]

Role : 금융 애널리스트
Industry : 금융, 투자, 자산관리
Type : 분기별 투자 리포트, 포트폴리오 분석

[Color Guide]
Background : 클린 화이트(#FFFFFF)
Text Color : 금융 블랙(#000000), 서브 텍스트 다크 그레이(#374151)
Accent : 상승 그린(#16A34A), 하락 레드(#DC2626), 중립 블루(#2563EB)
Font : Arial 또는 맑은 고딕 (가독성 우선 Sans-serif)

[Tone & Manner]
정확하고 객관적인 데이터 중심 분석. 리스크와 기회를 균형있게 제시. 명확한 수치와 근거 기반 권고사항.

[Image Principles]
전문적인 차트와 그래프가 중심. 금융 아이콘(화살표, 통화 기호) 활용. 색상 코딩으로 수익성 표시.

[Design Characteristics]
격자 기반 레이아웃. 표와 차트의 일관된 스타일링. 수치 데이터 강조를 위한 타이포그래피.

[Layout Guide]
- Title Slide : 리포트 제목과 기간, 회사 로고, 기밀성 표시
- Spec Slide : 핵심 지표 카드 형태, 전월 대비 변화율 표시
- Comparison Slide : 다중 컬럼 성과 비교표, 색상 코딩된 지표
- CTA Slide : 투자 권고안과 리스크 평가, 담당자 연락처
- Tone : 전문적이고 신뢰할 수 있는
- Slide count : 7 pages
- Font size contrast : 제목 28pt / 데이터 헤더 20pt / 본문 16pt / 수치 강조 24pt
- Text per slide : 35-50단어, 지표와 인사이트 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "럭셔리 브랜드 프레젠테이션",
    type: "Luxury Brand · Campaign Proposal",
    colors: ["#0A0A0A", "#D4AF37", "#8B2635"],
    cardBg:
      "linear-gradient(135deg, rgba(212,175,55,0.10), rgba(10,10,10,0.06))",
    numBg: "rgba(212,175,55,0.14)",
    numColor: "#9a7a18",
    prompt: `[NotebookLM Slide Design Guide]

Role : 브랜드 디렉터
Industry : 럭셔리 패션, 프리미엄 라이프스타일
Type : 브랜드 전략 발표, 캠페인 제안

[Color Guide]
Background : 엘레간트 아이보리(#FAF9F6) 또는 딥 블랙(#0A0A0A)
Text Color : 샴페인 골드(#D4AF37), 플래티넘 실버(#C0C0C0)
Accent : 버건디(#8B2635), 로열 네이비(#1E3A8A) 포인트 사용
Font : Playfair Display (제목), Lato (본문) - 세리프와 Sans-serif 조합

[Tone & Manner]
세련되고 고급스러운 감성. 브랜드 헤리티지와 장인정신 강조. 감성적 스토리텔링과 독점성 표현.

[Image Principles]
고품질 제품 사진, 부드러운 조명과 그라데이션. 미니멀한 구성과 여백 활용. 브랜드 아이덴티티 일관성 유지.

[Design Characteristics]
극도의 미니멀리즘과 여백 활용. 중앙 정렬 중심. 얇은 라인과 세련된 구분선 사용.

[Layout Guide]
- Title Slide : 중앙 브랜드명, 최소한의 장식 요소, 하단 작은 로고
- Spec Slide : 대형 이미지 좌측, 우측 간결한 제품 정보
- Comparison Slide : 우아한 2컬럼 비교, 골드 하이라이트
- CTA Slide : 중앙 집중 메시지, 연락처는 작고 우아하게
- Tone : 품격 있고 독점적인
- Slide count : 7 pages
- Font size contrast : 제목 48pt / 본문 18pt, 우아한 비율 유지
- Text per slide : 15-30단어, 이미지가 메인 스토리

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "크리에이티브 에이전시 포트폴리오",
    type: "Creative Agency · Portfolio",
    colors: ["#0F0F0F", "#00F0FF", "#FF0080"],
    cardBg:
      "linear-gradient(135deg, rgba(0,240,255,0.09), rgba(255,0,128,0.06))",
    numBg: "rgba(0,240,255,0.12)",
    numColor: "#009aaa",
    prompt: `[NotebookLM Slide Design Guide]

Role : 크리에이티브 디렉터
Industry : 광고, 디자인 에이전시
Type : 포트폴리오 쇼케이스, 케이스 스터디

[Color Guide]
Background : 다이나믹 블랙(#0F0F0F) 또는 퓨어 화이트(#FFFFFF)
Text Color : 하이 컨트래스트 화이트/블랙, 네온 액센트
Accent : 일렉트릭 시안(#00F0FF), 네온 핑크(#FF0080), 라임 그린(#CCFF00)
Font : Montserrat (Bold, ExtraBold), Poppins (본문)

[Tone & Manner]
대담하고 혁신적인. 창의성과 결과를 동시에 어필. 간결하지만 임팩트 있는 카피라이팅.

[Image Principles]
대형 풀블리드 캠페인 이미지. 다이나믹한 구성과 모션 블러 효과. 작업물이 중심이 되는 레이아웃.

[Design Characteristics]
실험적이고 비대칭적 레이아웃. 겹치는 요소와 레이어링. 대담한 타이포그래피 실험.

[Layout Guide]
- Title Slide : 에이전시명 대형 타이포, 창의적 태그라인
- Spec Slide : 케이스 스터디 형식, 문제-해결-결과 구조
- Comparison Slide : 드라마틱한 Before/After, 성과 지표 오버레이
- CTA Slide : 강렬한 콜투액션, 멀티 컨택 포인트
- Tone : 혁신적이고 기억에 남는
- Slide count : 7 pages
- Font size contrast : 극대 비율 (72pt vs 18pt), 드라마틱한 위계
- Text per slide : 10-25단어, 비주얼이 메인 메시지

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "교육기관 학술 발표",
    type: "Academic · Conference Presentation",
    colors: ["#F0F9FF", "#2563EB", "#F97316"],
    cardBg:
      "linear-gradient(135deg, rgba(37,99,235,0.08), rgba(249,115,22,0.05))",
    numBg: "rgba(37,99,235,0.10)",
    numColor: "#2563EB",
    prompt: `[NotebookLM Slide Design Guide]
...
[Color Guide]
Background : 아카데믹 화이트(#FEFEFE) 또는 소프트 블루(#F0F9FF)
Text Color : 스콜라 네이비(#1E293B), 서브 그레이(#475569)
Accent : 아카데믹 블루(#2563EB), 하이라이트 오렌지(#F97316)
Font : Source Sans Pro (제목), Georgia (본문) - 학술적 가독성 중심

[Tone & Manner]
학술적 엄밀함과 접근성의 균형. 방법론과 결과를 명확히 제시. 적절한 인용과 근거 기반 논증.

[Image Principles]
명확한 다이어그램과 차트. 교육적 인포그래픽. 다큐멘터리 스타일 사진과 적절한 출처 표기.

[Design Characteristics]
정돈되고 정보 밀도가 높은 레이아웃. 일관된 그래프 스타일. 명확한 범례와 라벨링.

[Layout Guide]
- Title Slide : 연구 제목 중앙, 저자 정보와 소속 기관, 날짜 하단
- Spec Slide : 연구 방법론 단계별 설명, 우측 지원 다이어그램
- Comparison Slide : 데이터 테이블 또는 막대 그래프, 통계적 유의성 표시
- CTA Slide : 핵심 발견사항 요약, 참고문헌과 협업 연락처
- Tone : 학술적이고 권위있는
- Slide count : 7 pages
- Font size contrast : 제목 36pt / 서브 24pt / 본문 18pt, 계층적 구조
- Text per slide : 40-60단어, 학술적 맥락에서 적절한 정보량

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "비영리단체 임팩트 리포트",
    type: "Nonprofit · Annual Impact Report",
    colors: ["#FBF8F3", "#EA580C", "#15803D"],
    cardBg:
      "linear-gradient(135deg, rgba(234,88,12,0.08), rgba(21,128,61,0.06))",
    numBg: "rgba(234,88,12,0.10)",
    numColor: "#c2450a",
    prompt: `[NotebookLM Slide Design Guide]

Role : 비영리 단체 대표
Industry : 사회적 기업, NGO
Type : 연간 임팩트 리포트, 후원자 보고서

[Color Guide]
Background : 따뜻한 오프화이트(#FBF8F3) 또는 소프트 베이지(#F4EDE4)
Text Color : 어스 브라운(#44403C), 웜 그레이(#57534E)
Accent : 희망 오렌지(#EA580C), 자연 그린(#15803D), 커뮤니티 블루(#0284C7)
Font : Merriweather (제목), Source Sans Pro (본문) - 따뜻하고 인간적인 느낌

[Tone & Manner]
진정성 있고 감동적인 스토리텔링. 구체적 성과와 인간적 스토리의 균형. 투명성과 책임감 강조.

[Image Principles]
진정성 있는 다큐멘터리 사진 (동의 하에). 따뜻한 자연광과 인간적 연결감. 다양성과 포용성 표현.

[Design Characteristics]
따뜻하고 접근하기 쉬운 디자인. 유기적 형태와 부드러운 모서리. 스토리텔링을 위한 시각적 내러티브.

[Layout Guide]
- Title Slide : 미션 스테이트먼트와 감동적 수혜자 사진, 단체 로고
- Spec Slide : 임팩트 지표를 원형 배지로, 인간 스토리와 함께
- Comparison Slide : 연도별 성장을 일러스트 타임라인으로, 마일스톤 표시
- CTA Slide : 참여 방법 (후원, 자원봉사, 파트너십), 영감을 주는 마무리 메시지
- Tone : 영감을 주고 투명한
- Slide count : 7 pages
- Font size contrast : 제목 42pt / 본문 20pt, 따뜻함 유지
- Text per slide : 25-45단어, 스토리와 데이터의 균형

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
];

function handleVipCat(cat) {
  closeVipPopup();
  document
  ...
  if (cat === "designer") renderVipDesigner7();
  else if (cat === "image") renderVipImage14();
  else if (cat === "brand") renderVipBrands14();
  else renderVipMaterial14();
}

// ── Material Style Best 14 ────────────────────────────────
export const MATERIAL_14 = [
  {
    name: "크리스탈 워터 재질",
    type: "Crystal Water · Wellness Brand",
    colors: ["#F0FBFF", "#00BCD4", "#4DD0E1"],
    cardBg:
      "linear-gradient(135deg, rgba(0,188,212,0.09), rgba(77,208,225,0.06))",
    numBg: "rgba(0,188,212,0.11)",
    numColor: "#0097a7",
    prompt: `[NotebookLM Slide Design Guide]

Role : 웰니스 브랜드 디렉터
Industry : 뷰티, 스킨케어, 웰니스, 생수
Type : 제품 소개, 브랜드 스토리

[Color Guide]
Background : 아쿠아 화이트(#F0FBFF) 또는 딥 아쿠아(#E0F7FA)
Text Color : 오션 블루(#006064), 딥 틸(#004D40)
Accent : 크리스탈 블루(#00BCD4), 아쿠아마린(#4DD0E1), 화이트 폼(#E1F5FE)
Font : Montserrat Light (영문), 나눔바른고딕 (한글)

[Tone & Manner]
청량하고 순수한 톤. 투명성과 깨끗함 강조. 자연의 생명력과 수분감 전달.

[Image Principles]
물의 유동적이고 투명한 특성 표현. 물방울과 리플 효과, 파동의 동심원. 수중에서의 빛 굴절과 반사. 크리스탈처럼 맑은 투명도. 수면 위 물보라와 스플래시 순간 포착. 부드러운 그라데이션과 블러 효과. 물의 흐름과 움직임 표현. 청량한 색상 팔레트와 하이라이트. 기포와 거품의 섬세한 디테일. 투명한 액체가 흘러내리거나 튀는 모션을 정지 이미지로 표현.

[Design Characteristics]
유동적이고 부드러운 레이아웃. 곡선과 물결 형태 활용. 투명도와 레이어링. 라이트한 느낌의 구성.

[Layout Guide]
- Title Slide : 물결 배경, 중앙 타이틀에 물방울 효과
- Spec Slide : 좌측 물 이미지, 우측 투명 카드에 정보
- Comparison Slide : 물결로 구분된 좌우 비교, 리플 효과
- CTA Slide : 물방울 버튼 스타일, "Dive in" 메시지
- Tone : 청량하고 순수한
- Slide count : 7 pages
- Font size contrast : 제목 44pt / 본문 20pt / 캡션 16pt
- Text per slide : 20-35단어, 깨끗하고 간결하게

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "내추럴 우드 재질",
    type: "Natural Wood · Eco Lifestyle",
    colors: ["#F5F1E8", "#795548", "#558B2F"],
    cardBg:
      "linear-gradient(135deg, rgba(121,85,72,0.09), rgba(85,139,47,0.06))",
    numBg: "rgba(121,85,72,0.11)",
    numColor: "#6d4c41",
    prompt: `[NotebookLM Slide Design Guide]

Role : 지속가능성 매니저
Industry : 친환경 제품, 가구, 라이프스타일
Type : 브랜드 철학, 제품 라인 소개

[Color Guide]
Background : 내추럴 베이지(#F5F1E8) 또는 라이트 우드(#E8DCC4)
Text Color : 다크 우드(#3E2723), 에스프레소(#4E342E)
Accent : 월넛 브라운(#795548), 오크 탄(#A1887F), 포레스트 그린(#558B2F)
Font : Lora (영문), 나눔명조 (한글)

[Tone & Manner]
따뜻하고 자연친화적인 톤. 장인정신과 지속가능성 강조. 시간이 만든 가치 표현.

[Image Principles]
나무의 결과 나이테 텍스처 강조. 자연스러운 목재 그레인 패턴. 따뜻한 우드 톤과 자연광. 손으로 만진 듯한 촉각적 질감. 매트 피니시와 오일 마감 효과. 나무 단면과 자연스러운 엣지. 수공예품과 장인의 손길. 친환경 소재와 자연 요소. 빈티지하고 오가닉한 분위기. 원목 테이블과 나뭇결이 보이는 표면.

[Design Characteristics]
유기적이고 따뜻한 레이아웃. 자연스러운 비대칭. 텍스처 배경 활용. 수작업 느낌의 디테일.

[Layout Guide]
- Title Slide : 우드 텍스처 배경, 새겨진 듯한 타이틀
- Spec Slide : 좌측 제품, 우측 우드 플랭크에 정보
- Comparison Slide : 나무 프레임으로 구분된 비교
- CTA Slide : 나무판 스타일 버튼, 손글씨 느낌
- Tone : 따뜻하고 진정성 있는
- Slide count : 7 pages
- Font size contrast : 제목 38pt / 본문 18pt / 캡션 16pt
- Text per slide : 25-40단어, 스토리텔링 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "마블 스톤 재질",
    type: "Marble Stone · Luxury Interior",
    colors: ["#FAFAFA", "#D4AF37", "#2F4F4F"],
    cardBg:
      "linear-gradient(135deg, rgba(212,175,55,0.10), rgba(47,79,79,0.05))",
    numBg: "rgba(212,175,55,0.13)",
    numColor: "#9a7a18",
    prompt: `[NotebookLM Slide Design Guide]

Role : 럭셔리 브랜드 매니저
Industry : 고급 인테리어, 주얼리, 프리미엄 서비스
Type : 럭셔리 브랜드 발표, VIP 제안

[Color Guide]
Background : 마블 화이트(#FAFAFA) 또는 그레이 마블(#E8E8E8)
Text Color : 마블 블랙(#2C2C2C), 차콜 그레이(#424242)
Accent : 골드 베인(#D4AF37), 로즈 골드(#B76E79), 다크 그린 베인(#2F4F4F)
Font : Playfair Display (영문), 본명조 (한글)

[Tone & Manner]
우아하고 고급스러운 톤. 영구적 가치와 품격 강조. 타임리스한 럭셔리 표현.

[Image Principles]
대리석의 자연스러운 베이닝 패턴. 광택 나는 폴리시 마감과 반사. 고급스러운 질감과 무게감. 골드/실버 베인의 우아한 흐름. 차갑고 매끈한 표면 질감. 자연석의 유니크한 패턴. 클래식한 조명과 그림자. 모노크롬 또는 서브틀 컬러 팔레트. 건축적이고 견고한 느낌. 화이트·블랙·그린 마블 등 컬러 버라이어티.

[Design Characteristics]
대칭적이고 균형잡힌 레이아웃. 고급스러운 여백 활용. 얇은 골드 라인 액센트. 클래식한 구성.

[Layout Guide]
- Title Slide : 마블 텍스처 배경, 중앙 골드 타이틀
- Spec Slide : 좌측 마블 패널, 우측 골드 프레임 정보
- Comparison Slide : 마블 컬럼으로 구분된 비교
- CTA Slide : 마블 플레이트 위 골드 메시지
- Tone : 우아하고 타임리스한
- Slide count : 7 pages
- Font size contrast : 제목 48pt / 본문 20pt / 캡션 16pt
- Text per slide : 15-30단어, 간결하고 품격있게

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "소프트 코튼 재질",
    type: "Soft Cotton · Home Textile",
    colors: ["#FEFEFE", "#FFE4E1", "#E3F2FD"],
    cardBg:
      "linear-gradient(135deg, rgba(255,228,225,0.20), rgba(227,242,253,0.15))",
    numBg: "rgba(179,157,219,0.15)",
    numColor: "#7e57c2",
    prompt: `[NotebookLM Slide Design Guide]

Role : 라이프스타일 브랜드 디렉터
Industry : 패브릭, 홈 텍스타일, 베이비 제품
Type : 제품 컬렉션, 시즌 라인 소개

[Color Guide]
Background : 코튼 화이트(#FEFEFE) 또는 소프트 크림(#FAF9F6)
Text Color : 린넨 그레이(#8B8680), 타우페(#9B8E82)
Accent : 블러쉬 핑크(#FFE4E1), 스카이 블루(#E3F2FD), 민트 크림(#F0FFF0)
Font : Quicksand (영문), 나눔바른고딕 (한글)

[Tone & Manner]
부드럽고 편안한 톤. 안락함과 포근함 강조. 일상의 작은 행복 전달.

[Image Principles]
부드럽고 푹신한 패브릭 텍스처. 자연스러운 주름과 드레이프. 매트하고 촉감이 느껴지는 표면. 파스텔 톤의 따뜻한 컬러. 소프트 포커스와 디퓨즈 라이팅. 레이어드 패브릭과 겹침 효과. 섬유의 섬세한 질감 표현. 편안한 라이프스타일 시나리오. 공기감 있는 가벼운 느낌. 린넨의 거친 직조감과 코튼의 부드러운 표면.

[Design Characteristics]
소프트하고 에어리한 레이아웃. 둥근 모서리와 부드러운 형태. 충분한 여백과 호흡. 편안한 시각적 흐름.

[Layout Guide]
- Title Slide : 패브릭 텍스처 배경, 자수 느낌 타이틀
- Spec Slide : 좌측 제품 이미지, 우측 소프트 박스 정보
- Comparison Slide : 패브릭 스와치 스타일 비교
- CTA Slide : 쿠션 같은 버튼, "Feel the comfort"
- Tone : 부드럽고 포근한
- Slide count : 7 pages
- Font size contrast : 제목 40pt / 본문 20pt / 캡션 18pt
- Text per slide : 20-35단어, 감성적 표현

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "럭셔리 골드 재질",
    type: "Luxury Gold · Premium Jewelry",
    colors: ["#0A0A0A", "#D4AF37", "#B76E79"],
    cardBg:
      "linear-gradient(135deg, rgba(212,175,55,0.12), rgba(183,110,121,0.07))",
    numBg: "rgba(212,175,55,0.15)",
    numColor: "#9a7a18",
    prompt: `[NotebookLM Slide Design Guide]

Role : 프리미엄 브랜드 전략가
Industry : 주얼리, 럭셔리 굿즈, 프리미엄 서비스
Type : 하이엔드 제품 런칭, VIP 이벤트

[Color Guide]
Background : 딥 블랙(#0A0A0A) 또는 샴페인(#F7E7CE)
Text Color : 골드(#D4AF37), 화이트(#FFFFFF)
Accent : 로즈 골드(#B76E79), 옐로우 골드(#FFD700), 브론즈(#CD7F32)
Font : Bodoni (영문), 본명조 (한글)

[Tone & Manner]
럭셔리하고 독점적인 톤. 최상의 품질과 장인정신. 영원한 가치 강조.

[Image Principles]
광택 나는 골드 표면과 반사. 메탈릭 하이라이트와 스페큘러 효과. 부드러운 브러시드 골드 텍스처. 보석같은 디테일과 정교함. 극적인 조명과 렌즈 플레어. 블랙 배경에 골드 강조. 3D 메탈릭 렌더링. 엠보싱과 각인 효과. 프리미엄 패키징 이미지. 헤어라인 마감된 금속 표면과 묵직한 황동.

[Design Characteristics]
대담하고 럭셔리한 레이아웃. 블랙과 골드의 강렬한 대비. 미니멀하지만 임팩트 있는 구성. 대칭과 균형.

[Layout Guide]
- Title Slide : 블랙 배경, 대형 골드 타이틀, 렌즈 플레어
- Spec Slide : 중앙 제품 샷, 골드 프레임 정보
- Comparison Slide : 골드 라인으로 구분, 프리미엄 차별화
- CTA Slide : 골드 버튼, "Experience Luxury"
- Tone : 독점적이고 프리미엄한
- Slide count : 7 pages
- Font size contrast : 제목 52pt / 본문 20pt / 캡션 16pt
- Text per slide : 10-20단어, 강력한 메시지

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "홀로그래픽 레인보우 재질",
    type: "Holographic Rainbow · Future Trend",
    colors: ["#FEFEFE", "#FF00FF", "#00FFFF"],
    cardBg:
      "linear-gradient(135deg, rgba(255,0,255,0.08), rgba(0,255,255,0.06))",
    numBg: "rgba(100,100,200,0.10)",
    numColor: "#5a3fa0",
    prompt: `[NotebookLM Slide Design Guide]

Role : 이노베이션 디렉터
Industry : 테크, 패션, 엔터테인먼트
Type : 미래 비전 발표, 트렌드 리포트

[Color Guide]
Background : 홀로 화이트(#FEFEFE) 또는 아이리디센트 그레이(#E8E8E8)
Text Color : 홀로 블랙(#1A1A1A), 다크 퍼플(#4A148C)
Accent : 레인보우 그라데이션(#FF00FF → #00FFFF → #FFFF00), 홀로그래픽 실버(#C0C0C0)
Font : Futura (영문), Pretendard (한글)

[Tone & Manner]
미래지향적이고 혁신적인 톤. 무한한 가능성과 다양성. 변화하는 트렌드 표현.

[Image Principles]
홀로그래픽 레인보우 반사 효과. 각도에 따라 변하는 색상 표현. 아이리디센트 그라데이션과 시프트. 프리즘 효과와 빛의 분산. 메탈릭하면서 투명한 질감. CD/DVD 표면 같은 패턴. 퓨처리스틱한 텍스처. 다이나믹한 컬러 플레이. 디지털 글리치 효과 결합. 무지개빛으로 변하는 메탈릭/필름 표면과 오일 슬릭 질감.

[Design Characteristics]
다이나믹하고 미래적 레이아웃. 그라데이션과 컬러 시프트. 레이어와 투명도 활용. 실험적 구성.

[Layout Guide]
- Title Slide : 홀로그래픽 배경, 레인보우 타이틀 효과
- Spec Slide : 좌측 홀로 이미지, 우측 그라데이션 카드
- Comparison Slide : 컬러 시프트로 구분된 비교
- CTA Slide : 홀로그래픽 버튼, "Join the Future"
- Tone : 미래적이고 다이나믹한
- Slide count : 7 pages
- Font size contrast : 제목 48pt / 본문 20pt
- Text per slide : 15-30단어, 혁신적 메시지

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "브러시드 메탈 재질",
    type: "Brushed Metal · Industrial Tech",
    colors: ["#D3D3D3", "#4A4A4A", "#878FA3"],
    cardBg:
      "linear-gradient(135deg, rgba(74,74,74,0.09), rgba(135,143,163,0.07))",
    numBg: "rgba(74,74,74,0.10)",
    numColor: "#4a4a4a",
    prompt: `[NotebookLM Slide Design Guide]

Role : 인더스트리얼 디자이너
Industry : 테크 하드웨어, 자동차, 프리미엄 가전
Type : 제품 스펙 발표, 기술 쇼케이스

[Color Guide]
Background : 메탈 그레이(#D3D3D3) 또는 건메탈(#8B8D8E)
Text Color : 스틸 블랙(#2F4F4F), 다크 그레이(#4A4A4A)
Accent : 알루미늄 실버(#C0C0C0), 티타늄 블루(#878FA3), 스틸 화이트(#F0F0F0)
Font : DIN (영문), 나눔고딕 (한글)

[Tone & Manner]
정밀하고 기술적인 톤. 내구성과 품질 강조. 엔지니어링 우수성 표현.

[Image Principles]
브러시드 메탈 표면 텍스처. 일정한 방향의 헤어라인 패턴. 매트하면서 반사적인 표면. 산업적이고 견고한 느낌. CNC 가공과 정밀함. 메탈 엣지와 챔퍼링. 기계적 디테일과 조립 구조. 테크니컬 드로잉 요소. 모노크롬 컬러 팔레트. 스틸, 알루미늄, 티타늄 느낌의 완전한 크롬/미러 반사 메탈 표면.

[Design Characteristics]
엔지니어링 드로잉 스타일. 정확한 정렬과 그리드. 기술적 다이어그램. 스펙 중심 구성.

[Layout Guide]
- Title Slide : 브러시드 메탈 배경, 각인된 타이틀
- Spec Slide : 좌측 제품 익스플로드 뷰, 우측 스펙 리스트
- Comparison Slide : 메탈 플레이트에 스펙 비교표
- CTA Slide : 메탈 버튼 스타일, "Built to Last"
- Tone : 정밀하고 신뢰할 수 있는
- Slide count : 7 pages
- Font size contrast : 제목 40pt / 본문 16pt / 스펙 14pt
- Text per slide : 30-50단어, 기술 정보 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "글리터 스파클 재질",
    type: "Glitter Sparkle · Event & Celebration",
    colors: ["#F7E7CE", "#FFD700", "#FF69B4"],
    cardBg:
      "linear-gradient(135deg, rgba(255,215,0,0.12), rgba(255,105,180,0.08))",
    numBg: "rgba(255,215,0,0.16)",
    numColor: "#9a6f00",
    prompt: `[NotebookLM Slide Design Guide]

Role : 이벤트 플래너
Industry : 엔터테인먼트, 파티 서비스, 축하 이벤트
Type : 이벤트 제안, 축하 프레젠테이션

[Color Guide]
Background : 샴페인 골드(#F7E7CE) 또는 로즈 골드(#F4C2C2)
Text Color : 딥 퍼플(#4A148C), 버건디(#8B0000)
Accent : 실버 글리터(#C0C0C0), 골드 글리터(#FFD700), 로즈 핑크(#FF69B4)
Font : Pacifico (영문), 배민 주아 (한글)

[Tone & Manner]
화려하고 축제적인 톤. 특별한 순간과 기쁨 강조. 매직과 반짝임 표현.

[Image Principles]
미세한 글리터 파티클과 반짝임. 빛을 반사하는 스파클 효과. 보케와 렌즈 플레어. 컨페티와 축하 요소. 샴페인 버블과 골드 톤. 반짝이는 텍스처 레이어. 매직 더스트 효과. 파티 라이팅과 디스코볼. 럭셔리하면서 플레이풀한 분위기. 반짝이는 하이글로시 플라스틱 표면과 스펙큘러 하이라이트.

[Design Characteristics]
화려하고 축제적인 레이아웃. 글리터 액센트 포인트. 레이어드 스파클 효과. 다이나믹한 구성.

[Layout Guide]
- Title Slide : 글리터 배경, 반짝이는 타이틀 효과
- Spec Slide : 좌측 이미지, 우측 골드 프레임 정보
- Comparison Slide : 컨페티로 구분된 플랜 비교
- CTA Slide : 스파클 버튼, "Celebrate with Us"
- Tone : 화려하고 즐거운
- Slide count : 7 pages
- Font size contrast : 제목 50pt / 본문 22pt
- Text per slide : 15-25단어, 감성적 카피

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "프로스티드 글라스 재질",
    type: "Frosted Glass · Modern App UI",
    colors: ["#E3F2FD", "#64B5F6", "#00E5FF"],
    cardBg:
      "linear-gradient(135deg, rgba(100,181,246,0.10), rgba(0,229,255,0.07))",
    numBg: "rgba(100,181,246,0.13)",
    numColor: "#1976d2",
    prompt: `[NotebookLM Slide Design Guide]

Role : UI/UX 디자이너
Industry : 모던 테크, 프리미엄 앱, 디지털 서비스
Type : 앱 소개, 인터페이스 디자인 발표

[Color Guide]
Background : 그라데이션(#E3F2FD → #BBDEFB) 또는 소프트 화이트(#FAFAFA)
Text Color : 글라스 블랙(#263238), 미디엄 그레이(#546E7A)
Accent : 프로스트 블루(#64B5F6), 아이스 화이트(#E1F5FE), 글로우 시안(#00E5FF)
Font : SF Pro Display (영문), Pretendard (한글)

[Tone & Manner]
모던하고 세련된 톤. 투명성과 깊이감. 미래적 사용자 경험 강조.

[Image Principles]
반투명 유리 효과와 백그라운드 블러. 프로스티드 글라스 텍스처. 플로팅 UI 요소와 레이어. 서브틀한 화이트 보더와 글로우. 배경이 비치는 투명도 효과. 부드러운 그림자와 깊이. 글라스모피즘 디자인 원칙. 라이트 리플렉션과 굴절. 에어리하고 모던한 느낌. 빛의 굴절과 왜곡, 겹쳐진 유리판의 깊이감.

[Design Characteristics]
레이어드 인터페이스 디자인. 투명도를 활용한 깊이감. 미니멀하면서 프리미엄한 구성. 플로팅 요소.

[Layout Guide]
- Title Slide : 글라스 카드 중앙, 백그라운드 블러
- Spec Slide : 여러 글라스 패널 레이어드 배치
- Comparison Slide : 좌우 프로스티드 카드 비교
- CTA Slide : 글라스 버튼, 글로우 효과
- Tone : 모던하고 투명한
- Slide count : 7 pages
- Font size contrast : 제목 42pt / 본문 18pt
- Text per slide : 20-35단어, 간결하고 명확하게

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "네온 플라스틱 재질",
    type: "Neon Plastic · Street Culture MZ",
    colors: ["#0F0F0F", "#FF10F0", "#39FF14"],
    cardBg:
      "linear-gradient(135deg, rgba(255,16,240,0.09), rgba(57,255,20,0.06))",
    numBg: "rgba(255,16,240,0.11)",
    numColor: "#cc00c0",
    prompt: `[NotebookLM Slide Design Guide]

Role : 트렌드 마케터
Industry : 패션, MZ세대 브랜드, 스트리트 컬처
Type : 트렌드 리포트, 브랜드 캠페인

[Color Guide]
Background : 네온 블랙(#0F0F0F) 또는 사이버 그레이(#1A1A1A)
Text Color : 네온 화이트(#FFFFFF), 일렉트릭 시안(#00FFFF)
Accent : 네온 핑크(#FF10F0), 네온 그린(#39FF14), 네온 옐로우(#FFFF00), 네온 블루(#1B03A3)
Font : Archivo Black (영문), 배민 주아 (한글)

[Tone & Manner]
대담하고 에너제틱한 톤. 젊음과 반항 정신. 트렌디하고 눈에 띄는 접근.

[Image Principles]
반짝이는 플라스틱 표면 질감. 네온 컬러의 강렬한 발광 효과. 글로시한 하이라이트와 반사. 90년대 레이브 문화 미학. 형광 컬러와 고대비. 플라스틱 투명도와 컬러 레이어. 아크릴 재질 느낌. 글로우 효과와 블룸. 스트리트 아트와 그래피티 요소. 어둠 속에서 빛나는 네온 사인 튜브와 빛 번짐 효과.

[Design Characteristics]
대담하고 충격적인 레이아웃. 네온 보더와 글로우 효과. 다크 배경에 네온 강조. 실험적 구성.

[Layout Guide]
- Title Slide : 네온 플라스틱 배경, 발광 타이틀
- Spec Slide : 좌측 네온 이미지, 우측 플라스틱 카드
- Comparison Slide : 네온 컬러로 구분된 비교
- CTA Slide : 네온 버튼, "Light it up"
- Tone : 대담하고 트렌디한
- Slide count : 7 pages
- Font size contrast : 제목 56pt / 본문 20pt
- Text per slide : 10-20단어, 임팩트 메시지

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "매트 세라믹 재질",
    type: "Matte Ceramic · Minimal Product Design",
    colors: ["#F8F8F8", "#E07A5F", "#457B9D"],
    cardBg:
      "linear-gradient(135deg, rgba(224,122,95,0.09), rgba(69,123,157,0.06))",
    numBg: "rgba(224,122,95,0.11)",
    numColor: "#c05a40",
    prompt: `[NotebookLM Slide Design Guide]

Role : 프로덕트 디자이너
Industry : 미니멀 디자인, 홈웨어, 프리미엄 가전
Type : 제품 디자인 발표, 컬렉션 소개

[Color Guide]
Background : 세라믹 화이트(#F8F8F8) 또는 포슬린 그레이(#E5E5E5)
Text Color : 차콜(#3A3A3A), 미디엄 그레이(#757575)
Accent : 테라코타(#E07A5F), 세이지 그린(#A8DADC), 더스티 블루(#457B9D)
Font : Helvetica Neue (영문), Apple SD Gothic Neo (한글)

[Tone & Manner]
미니멀하고 세련된 톤. 장인정신과 디테일. 기능미와 심플함 강조.

[Image Principles]
부드럽고 매트한 세라믹 표면. 균일하고 깨끗한 텍스처. 서브틀한 그림자와 하이라이트. 미니멀한 형태와 곡선. 자연광 아래 부드러운 톤. 핸드메이드 느낌의 불완전함. 모노크롬 또는 어스 톤 팔레트. 제품 디테일 클로즈업. 공간과 여백 강조. 매끄러운 도자기의 유약 질감과 미세한 크랙 무늬.

[Design Characteristics]
미니멀하고 정돈된 레이아웃. 충분한 화이트 스페이스. 중앙 정렬과 대칭. 클린한 구성.

[Layout Guide]
- Title Slide : 세라믹 배경, 엠보싱 타이틀 효과
- Spec Slide : 중앙 제품 샷, 미니멀 정보 배치
- Comparison Slide : 세라믹 플레이트 스타일 비교
- CTA Slide : 세라믹 버튼, "Experience Simplicity"
- Tone : 미니멀하고 우아한
- Slide count : 7 pages
- Font size contrast : 제목 36pt / 본문 16pt
- Text per slide : 15-25단어, 간결하고 정제된

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "파스텔 솜사탕 재질",
    type: "Pastel Cotton Candy · Kids & Bakery",
    colors: ["#FFE5EC", "#B2DFDB", "#E1BEE7"],
    cardBg:
      "linear-gradient(135deg, rgba(255,229,236,0.25), rgba(225,190,231,0.15))",
    numBg: "rgba(179,157,219,0.15)",
    numColor: "#7e57c2",
    prompt: `[NotebookLM Slide Design Guide]

Role : 키즈 브랜드 매니저
Industry : 아동 제품, 베이커리, 파티 서비스
Type : 제품 컬렉션, 이벤트 제안

[Color Guide]
Background : 코튼 캔디 핑크(#FFE5EC) 또는 베이비 블루(#E3F2FD)
Text Color : 소프트 퍼플(#B39DDB), 라벤더(#9575CD)
Accent : 민트 그린(#B2DFDB), 피치(#FFCCBC), 레몬(#FFF9C4), 라일락(#E1BEE7)
Font : Bubblegum Sans (영문), 배민 키즈 (한글)

[Tone & Manner]
달콤하고 플레이풀한 톤. 동심과 즐거움. 꿈같은 판타지 세계 표현.

[Image Principles]
부드럽고 푹신한 솜사탕 텍스처. 파스텔 컬러의 드리미한 그라데이션. 에어리하고 가벼운 느낌. 구름 같은 소프트 포커스. 설탕 크리스탈과 반짝임. 보케와 소프트 라이팅. 판타지 요소와 마법 같은 분위기. 스위트하고 디저트 같은 비주얼. 키즈 프렌들리한 일러스트. 솜사탕처럼 폭신폭신한 구름·덩어리 형태와 몽글몽글한 덩어리들.

[Design Characteristics]
소프트하고 드리미한 레이아웃. 둥근 형태와 곡선 강조. 파스텔 그라데이션 배경. 플레이풀한 구성.

[Layout Guide]
- Title Slide : 솜사탕 구름 배경, 버블 타이틀
- Spec Slide : 좌측 제품, 우측 파스텔 말풍선 정보
- Comparison Slide : 솜사탕 컬러로 구분된 옵션
- CTA Slide : 구름 버튼, "Sweet Dreams"
- Tone : 달콤하고 꿈같은
- Slide count : 7 pages
- Font size contrast : 제목 48pt / 본문 22pt
- Text per slide : 15-25단어, 플레이풀한 카피

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "펠트 & 크래프트 재질",
    type: "Felt & Craft · DIY Education",
    colors: ["#D6C0B0", "#EF4444", "#22C55E"],
    cardBg:
      "linear-gradient(135deg, rgba(239,68,68,0.09), rgba(34,197,94,0.07))",
    numBg: "rgba(214,192,176,0.30)",
    numColor: "#7c5c4a",
    prompt: `[NotebookLM Slide Design Guide]
...
[Color Guide]
Background : 크래프트지 갈색(#D6C0B0) 또는 펠트 그레이(#E5E7EB)
Text Color : 매직 펜 블랙(#1F2937), 크레파스 색상
Accent : 펠트 레드(#EF4444), 펠트 그린(#22C55E), 펠트 블루(#3B82F6)
Font : Gaegu (손글씨 폰트)

[Tone & Manner]
아기자기하고 따뜻하며 손맛이 느껴지는 톤. 정성과 창의성 강조.

[Image Principles]
보송보송한 펠트 천 질감. 가위로 오린 듯한 거친 가장자리. 종이 찢김 효과. 골판지 텍스처. 딱풀과 테이프 자국. 손으로 만든 입체감. 매트 종이, 재생지, 카드보드 질감 배경. 종이의 결과 미세한 점/텍스처 표현. 포스트잇, 태그, 인덱스형 요소. 종이 클립, 스티커, 손글씨 포인트.

[Design Characteristics]
콜라주 기법 레이아웃. 스크랩북 스타일. 테이프로 붙인 듯한 사진 배치.

[Layout Guide]
- Title Slide : 펠트 천을 오려 붙여 만든 타이틀 글자
- Spec Slide : 코르크 보드에 압정으로 고정한 메모지
- Comparison Slide : 종이 인형극 무대 같은 좌우 배치
- CTA Slide : 손 편지 봉투가 열리는 이미지
- Tone : 친근하고 핸드메이드한
- Slide count : 7 pages
- Font size contrast : 제목 42pt / 본문 20pt
- Text per slide : 20-35단어, 대화체

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "크리스탈 아이스 재질",
    type: "Crystal Ice · Premium Beverage",
    colors: ["#F0F8FF", "#00BCD4", "#4DD0E1"],
    cardBg:
      "linear-gradient(135deg, rgba(0,105,148,0.09), rgba(0,188,212,0.07))",
    numBg: "rgba(0,105,148,0.11)",
    numColor: "#006994",
    prompt: `[NotebookLM Slide Design Guide]

Role : 프리미엄 음료 브랜드 매니저
Industry : 고급 음료, 럭셔리 F&B, 쿨링 제품
Type : 프리미엄 제품 런칭, 시즌 캠페인

[Color Guide]
Background : 아이스 화이트(#F0F8FF) 또는 글레이셔 블루(#E0F2F7)
Text Color : 프로스트 블루(#006994), 아이스 그레이(#546E7A)
Accent : 크리스탈 블루(#00BCD4), 다이아몬드 화이트(#E8F5E9), 아쿠아(#4DD0E1)
Font : Montserrat (영문), 나눔바른고딕 (한글)

[Tone & Manner]
시원하고 프리미엄한 톤. 순수함과 청량감. 크리스탈 같은 투명도 강조.

[Image Principles]
얼음 크리스탈의 각진 형태와 투명도. 빛의 굴절과 프리즘 효과. 서리와 결빙 텍스처. 차갑고 크리스탈라인한 표면. 얼음 조각과 샤드. 냉기가 느껴지는 비주얼. 다이아몬드 같은 반짝임. 프로스티한 엣지와 디테일. 블루-화이트 컬러 팔레트. 3D 와이어프레임 메쉬와 빛나는 데이터 라인의 차가운 느낌.

[Design Characteristics]
크리스탈처럼 각진 레이아웃. 기하학적 형태 활용. 투명도와 레이어링. 청량한 구성.

[Layout Guide]
- Title Slide : 크리스탈 아이스 배경, 프로스티 타이틀
- Spec Slide : 좌측 제품 이미지, 우측 아이스 크리스탈 프레임
- Comparison Slide : 얼음 조각으로 구분된 비교
- CTA Slide : 크리스탈 버튼, "Taste the Purity"
- Tone : 시원하고 프리미엄한
- Slide count : 7 pages
- Font size contrast : 제목 44pt / 본문 20pt
- Text per slide : 15-30단어, 청량한 카피

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
];

function renderVipMaterial14() {
  const promptArea = document.getElementById("promptArea");
  promptArea.innerHTML = `
    <div class="prompt-header">
      <div class="prompt-header-top">
        <span class="ph-category">⭐ VIP Best Collection</span>
        <span class="ph-arrow">›</span>
        <span class="ph-industry">Material Style Best 14</span>
      </div>
      <h2>Material Style Best 14 슬라이드 프롬프트</h2>
      <p>소재·질감으로 완성하는 14가지 고급 머티리얼 디자인 스타일입니다.</p>
    </div>
    <div class="prompt-grid" id="promptGrid"></div>
  `;
  const grid = document.getElementById("promptGrid");
  MATERIAL_14.forEach((design, i) => {
    const card = document.createElement("div");
    card.className = "prompt-card";
    card.innerHTML = `
      <div class="card-top">
        <div class="card-num" style="background:${design.numBg};color:${design.numColor}">${i + 1}</div>
        <div class="card-title-block">
          <div class="card-design-name">${design.name}</div>
          <div class="card-design-type">${design.type}</div>
        </div>
      </div>
      <div class="card-body">
        <div class="prompt-text" id="pt-${i}">${escapeHtml(design.prompt)}</div>
      </div>
      <div class="card-footer">
        <div class="color-swatches">
          ${design.colors.map((c) => `<div class="swatch" style="background:${c}"></div>`).join("")}
        </div>
        <button class="copy-btn" onclick="copyPrompt(${i}, this)">
...
// ── Brands Best 14 ────────────────────────────────────────
export const BRANDS_14 = [
  {
    name: "Apple 미니멀 프리미엄 스타일",
    type: "Apple · Premium Tech Keynote",
    colors: ["#FFFFFF", "#1D1D1F", "#007AFF"],
    cardBg:
      "linear-gradient(135deg, rgba(0,122,255,0.07), rgba(29,29,31,0.04))",
    numBg: "rgba(0,122,255,0.09)",
    numColor: "#007AFF",
    prompt: `[NotebookLM Slide Design Guide]

Role : 프로덕트 매니저
Industry : 프리미엄 테크놀로지, 하드웨어
Type : 제품 발표, 키노트 프레젠테이션

[Color Guide]
Background : 퓨어 화이트(#FFFFFF) 또는 딥 블랙(#000000)
Text Color : 애플 그레이(#1D1D1F), 세컨더리 그레이(#86868B)
Accent : 애플 블루(#007AFF), 다크 모드시 화이트(#FFFFFF)
Font : SF Pro Display (영문), Apple SD Gothic Neo (한글)

[Tone & Manner]
극도로 미니멀하고 세련된 톤. "심플함 속의 정교함" 추구. 제품 자체가 말하게 하는 접근법.

[Image Principles]
완벽한 조명의 고해상도 제품 사진. 순수한 화이트/블랙 배경. 극대화된 여백과 중앙 정렬. 제품 디테일 클로즈업. 소프트 셰도우와 리플렉션. 벤토 그리드(Bento Grid) 레이아웃. 불필요한 장식 요소 완전 제거. 프리미엄 매터리얼 질감 강조.

[Design Characteristics]
극단적 미니멀리즘. 화면의 60-70% 여백 활용. 얇은 라인과 섬세한 타이포그래피. 완벽한 대칭과 정렬.

[Layout Guide]
- Title Slide : 중앙 제품 이미지, 하단 간결한 한 줄 메시지
- Spec Slide : 대형 제품 이미지 70%, 우측 최소 스펙 정보
- Comparison Slide : 상하 분할, 제품 중심 시각적 비교
- CTA Slide : 중앙 "Learn more" 버튼, 최소한의 정보
- Tone : 세련되고 자신감 있는
- Slide count : 7 pages
- Font size contrast : 제목 64pt / 본문 24pt / 캡션 18pt
- Text per slide : 5-15단어, 핵심 메시지만

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Google Material Design 스타일",
    type: "Google · Material Design Platform",
    colors: ["#FFFFFF", "#4285F4", "#34A853"],
    cardBg:
      "linear-gradient(135deg, rgba(66,133,244,0.08), rgba(52,168,83,0.05))",
    numBg: "rgba(66,133,244,0.10)",
    numColor: "#4285F4",
    prompt: `[NotebookLM Slide Design Guide]

Role : UX 디자이너
Industry : 인터넷 서비스, 클라우드 플랫폼
Type : 서비스 소개, 기능 업데이트 발표

[Color Guide]
Background : 구글 화이트(#FFFFFF) 또는 라이트 그레이(#F8F9FA)
Text Color : 구글 그레이(#202124), 세컨더리 그레이(#5F6368)
Accent : 구글 블루(#4285F4), 레드(#EA4335), 옐로우(#FBBC04), 그린(#34A853)
Font : Google Sans (영문), Noto Sans KR (한글)

[Tone & Manner]
친근하고 접근하기 쉬운 톤. 사용자 중심적 사고. "For everyone" 철학 반영.

[Image Principles]
머티리얼 디자인 원칙 적용. 페이퍼 메타포와 레이어드 인터페이스. 부드러운 그림자(elevation)와 깊이감. 생생한 4색 컬러 팔레트. 플랫하면서도 입체적인 아이콘. 8dp 그리드 시스템. 의미 있는 모션 암시. 친근한 일러스트레이션. 실제 UI 스크린샷 활용.

[Design Characteristics]
카드 기반 레이아웃. 플로팅 액션 버튼 스타일. 그리드 시스템 엄격 적용. 컬러풀한 액센트.

[Layout Guide]
- Title Slide : 상단 좌측 로고, 중앙 대형 타이틀, 4색 액센트
- Spec Slide : 3-4개 카드 형태, 각각 아이콘과 설명
- Comparison Slide : 좌우 카드 비교, 구글 컬러로 구분
- CTA Slide : 중앙 FAB 스타일 "Get started" 버튼
- Tone : 친근하고 도움이 되는
- Slide count : 7 pages
- Font size contrast : 제목 48pt / 서브 32pt / 본문 20pt
- Text per slide : 25-40단어, 명확한 액션 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Microsoft Fluent Design 스타일",
    type: "Microsoft · Enterprise Fluent Design",
    colors: ["#FFFFFF", "#0078D4", "#00BCF2"],
    cardBg:
      "linear-gradient(135deg, rgba(0,120,212,0.08), rgba(0,188,242,0.05))",
    numBg: "rgba(0,120,212,0.10)",
    numColor: "#0078D4",
    prompt: `[NotebookLM Slide Design Guide]

Role : 엔터프라이즈 솔루션 매니저
Industry : 비즈니스 소프트웨어, 클라우드 서비스
Type : 기업 솔루션 발표, B2B 제안서

[Color Guide]
Background : MS 화이트(#FFFFFF) 또는 라이트 블루(#F3F9FB)
Text Color : MS 블랙(#323130), 그레이(#605E5C)
Accent : MS 블루(#0078D4), 틸(#00BCF2), 오렌지(#FF8C00)
Font : Segoe UI (영문), 맑은 고딕 (한글)

[Tone & Manner]
프로페셔널하고 신뢰감 있는 톤. 생산성과 협업 가치 강조. 엔터프라이즈 중심 접근.

[Image Principles]
플루언트 디자인의 5가지 원칙 적용: 빛, 깊이, 모션, 재질, 스케일. 아크릴릭 머티리얼과 투명도 효과. 부드러운 그림자와 레이어링. 비즈니스 맥락의 일러스트레이션. 협업 도구 UI 스크린샷. 프로페셔널한 사진. 다이나믹한 라이팅 효과.

[Design Characteristics]
모던하고 프로페셔널한 레이아웃. 카드와 패널 시스템. 일관된 간격과 정렬. 비즈니스 친화적 구성.

[Layout Guide]
- Title Slide : 좌측 타이틀, 우측 프로덕트 비주얼
- Spec Slide : 헤더와 3컬럼 기능 카드 배치
- Comparison Slide : 테이블 또는 좌우 비교, 체크마크 활용
- CTA Slide : "Learn more" 버튼, 비즈니스 연락처
- Tone : 신뢰할 수 있고 효율적인
- Slide count : 7 pages
- Font size contrast : 제목 42pt / 서브 28pt / 본문 18pt
- Text per slide : 30-50단어, 비즈니스 가치 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Tesla 사이버 미래주의 스타일",
    type: "Tesla · Cyber Futurism Innovation",
    colors: ["#000000", "#E82127", "#5DADE2"],
    cardBg:
      "linear-gradient(135deg, rgba(232,33,39,0.09), rgba(93,173,226,0.06))",
    numBg: "rgba(232,33,39,0.11)",
    numColor: "#c01820",
    prompt: `[NotebookLM Slide Design Guide]

Role : 이노베이션 리더
Industry : 전기차, 에너지, 우주항공
Type : 제품 발표, 기술 혁신 쇼케이스

[Color Guide]
Background : 테슬라 블랙(#000000) 또는 다크 그레이(#171A20)
Text Color : 퓨어 화이트(#FFFFFF), 라이트 그레이(#E8E8E8)
Accent : 테슬라 레드(#E82127), 일렉트릭 블루(#5DADE2)
Font : Gotham (영문), Pretendard Bold (한글)

[Tone & Manner]
대담하고 미래지향적인 톤. 혁신과 지속가능성 강조. "Master Plan" 비전 제시.

[Image Principles]
극적인 조명의 고품질 제품 사진. 다크 배경에 차량 하이라이트. 미래적이고 클린한 인테리어. 기술 다이어그램과 성능 시각화. 와이드 앵글 드라마틱 구도. 사이버펑크 미학. 공장과 로봇 이미지. 우주와 지구 배경. 미니멀하면서 강렬한 비주얼.

[Design Characteristics]
다크 모드 중심. 강렬한 대비와 포인트. 얇은 라인 아트. 설계도면 스타일 요소.

[Layout Guide]
- Title Slide : 풀스크린 차량 이미지, 하단 모델명
- Spec Slide : 좌측 대형 이미지, 우측 핵심 성능 수치
- Comparison Slide : 성능 비교 그래프, 테슬라 우위 강조
- CTA Slide : "Order Now" 버튼, 간결한 가격 정보
- Tone : 혁신적이고 비전 중심적인
- Slide count : 7 pages
- Font size contrast : 제목 56pt / 수치 48pt / 본문 20pt
- Text per slide : 10-25단어, 임팩트 있는 메시지

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Samsung 프리미엄 테크 스타일",
    type: "Samsung · Premium Tech Showcase",
    colors: ["#FFFFFF", "#1428A0", "#6C4FA3"],
    cardBg:
      "linear-gradient(135deg, rgba(20,40,160,0.08), rgba(108,79,163,0.06))",
    numBg: "rgba(20,40,160,0.10)",
    numColor: "#1428A0",
    prompt: `[NotebookLM Slide Design Guide]

Role : 글로벌 프로덕트 매니저
Industry : 전자제품, 모바일, 디스플레이
Type : 신제품 발표, 기술 쇼케이스

[Color Guide]
Background : 삼성 화이트(#FFFFFF) 또는 라이트 그레이(#F4F4F4)
Text Color : 삼성 블랙(#000000), 다크 그레이(#5A5A5A)
Accent : 삼성 블루(#1428A0), 바이올렛(#6C4FA3), 실버(#C0C0C0)
Font : Samsung Sharp Sans (영문), 삼성원 (한글)

[Tone & Manner]
혁신적이면서 접근 가능한 톤. 기술과 라이프스타일의 조화. "Do What You Can't" 정신.

[Image Principles]
프리미엄 제품 사진, 스튜디오 퀄리티 조명. 다양한 앵글과 디테일 샷. 라이프스타일 컨텍스트. 선명한 디스플레이 화면 강조. 프로덕트 패밀리 라인업. 혁신 기술 시각화. 글로벌 다양성 표현. 파라메트릭 픽셀 패턴. 미래적 그라데이션 효과.

[Design Characteristics]
모던하고 세련된 레이아웃. 와이드 화면 구성. 기술과 감성의 균형. 프리미엄 느낌의 여백.

[Layout Guide]
- Title Slide : 중앙 제품 히어로 샷, 상단 로고, 하단 모델명
- Spec Slide : 좌측 제품, 우측 3-4개 핵심 혁신 기능
- Comparison Slide : 제품 라인업 비교, 프리미엄 차별화
- CTA Slide : "Experience Innovation", 체험 및 구매 링크
- Tone : 혁신적이고 프리미엄한
- Slide count : 7 pages
- Font size contrast : 제목 46pt / 서브 28pt / 본문 18pt
- Text per slide : 25-40단어, 기술 혜택 균형

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Figma 크리에이티브 콜라보 스타일",
    type: "Figma · Design System Collab",
    colors: ["#FFFFFF", "#A259FF", "#0ACF83"],
    cardBg:
      "linear-gradient(135deg, rgba(162,89,255,0.08), rgba(10,207,131,0.06))",
    numBg: "rgba(162,89,255,0.10)",
    numColor: "#7c3aed",
    prompt: `[NotebookLM Slide Design Guide]

Role : 디자인 시스템 리드
Industry : 디자인 툴, 협업 플랫폼
Type : 디자인 워크플로우, 시스템 가이드

[Color Guide]
Background : 피그마 화이트(#FFFFFF) 또는 다크 그레이(#2C2C2C)
Text Color : 블랙(#000000), 화이트(#FFFFFF)
Accent : 피그마 퍼플(#A259FF), 레드(#F24E1E), 그린(#0ACF83), 블루(#1ABCFE)
Font : Inter (다양한 굵기 활용)

[Tone & Manner]
크리에이티브하면서 프로페셔널한 톤. 협업의 즐거움과 디자인 프로세스 효율화 강조.

[Image Principles]
디자인 툴 UI 요소 활용 (레이어 패널, 속성창). 마우스 커서 그래픽. 벡터 도형들의 과감한 중첩. 원색의 강렬한 컬러 조합. 굵은 아웃라인과 생동감. 프레임과 컴포넌트 시각화. 협업 플로우 다이어그램. 실시간 코멘트 버블. 그리드와 가이드라인 표시.

[Design Characteristics]
플레이풀하고 모던한 레이아웃. 디자인 툴 느낌의 구성. 컬러풀한 액센트 포인트.

[Layout Guide]
- Title Slide : 여러 색상 커서가 제목 주변에 모인 형태
- Spec Slide : 디자인 툴 속성 패널처럼 정보 정리
- Comparison Slide : 프레임 두 개를 나란히 배치하여 비교
- CTA Slide : 코멘트 버블 형태의 "Try Figma" 메시지
- Tone : 창의적이고 협업적인
- Slide count : 7 pages
- Font size contrast : 제목 50pt / 본문 18pt
- Text per slide : 15-25단어, 시각적 임팩트 위주

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Notion 구조적 생산성 스타일",
    type: "Notion · Productivity Workflow",
    colors: ["#FFFFFF", "#37352F", "#2383E2"],
    cardBg:
      "linear-gradient(135deg, rgba(55,53,47,0.07), rgba(35,131,226,0.05))",
    numBg: "rgba(55,53,47,0.08)",
    numColor: "#37352F",
    prompt: `[NotebookLM Slide Design Guide]

Role : 프로덕티비티 전문가
Industry : 생산성 툴, 지식 관리
Type : 워크플로우 가이드, 온보딩 자료

[Color Guide]
Background : 노션 화이트(#FFFFFF) 또는 베이지(#FAF9F7)
Text Color : 노션 블랙(#37352F), 그레이(#787774)
Accent : 노션 블루(#2383E2), 레드(#EB5757), 옐로우(#FFDC49), 그린(#448361)
Font : Inter (영문), Pretendard (한글)

[Tone & Manner]
심플하고 유용한 톤. 생산성과 조직화 강조. 유연하고 커스터마이징 가능한 접근.

[Image Principles]
문서 스타일 페이지 레이아웃. 블록 기반 콘텐츠 구조. 이모지와 아이콘 적극 활용. 데이터베이스와 템플릿 시각화. 심플한 라인 일러스트. 조직화된 정보 구조. 콜아웃 박스와 토글 디자인. 협업 시나리오 표현.

[Design Characteristics]
문서 같은 슬라이드 구성. 블록 기반 레이아웃. 충분한 여백과 가독성 우선. 좌측 정렬 텍스트.

[Layout Guide]
- Title Slide : 커버 이미지, 아이콘과 제목 (문서 헤더 느낌)
- Spec Slide : 3단 컬럼 정보 박스, 이모지 포인트
- Comparison Slide : 데이터베이스 테이블 형태 비교
- CTA Slide : 콜아웃 박스 안에 핵심 행동 유도
- Tone : 명료하고 구조적인
- Slide count : 7 pages
- Font size contrast : 제목 30pt / 본문 16pt
- Text per slide : 40-70단어, 불렛 포인트 적극 활용

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Adobe Creative Suite 스타일",
    type: "Adobe · Creative Suite Showcase",
    colors: ["#2D2D30", "#FF0000", "#31A8FF"],
    cardBg:
      "linear-gradient(135deg, rgba(255,0,0,0.08), rgba(49,168,255,0.06))",
    numBg: "rgba(255,0,0,0.10)",
    numColor: "#cc0000",
    prompt: `[NotebookLM Slide Design Guide]

Role : 크리에이티브 디렉터
Industry : 디자인 소프트웨어, 크리에이티브 툴
Type : 크리에이티브 쇼케이스, 툴 데모

[Color Guide]
Background : 어도비 다크(#2D2D30) 또는 화이트(#FFFFFF)
Text Color : 화이트(#FFFFFF), 어도비 블랙(#000000)
Accent : 어도비 레드(#FF0000), 블루(#31A8FF), 퍼플(#9999FF), 오렌지(#FF9A00)
Font : Adobe Clean (영문), Source Han Sans (한글)

[Tone & Manner]
창의적이고 전문적인 톤. 크리에이티브 가능성과 전문성 강조.

[Image Principles]
크리에이티브 작업물 쇼케이스. 다양한 미디어 형태 (사진, 벡터, 비디오). 레이어와 블렌딩 모드 효과. 그라데이션과 컬러 팔레트. 전문적인 이미지 편집 결과. 타이포그래피 실험. 브러시와 텍스처 효과. 3D 렌더링과 모션 그래픽.

[Design Characteristics]
크리에이티브하고 다이나믹한 레이아웃. 툴 인터페이스 요소 활용. 아트워크 중심 구성.

[Layout Guide]
- Title Slide : 크리에이티브 아트워크 배경, CC 로고
- Spec Slide : 툴별 기능 쇼케이스, 작업 결과물
- Comparison Slide : Before/After 편집 결과 비교
- CTA Slide : "Create anything" 메시지, 체험판 링크
- Tone : 창의적이고 영감을 주는
- Slide count : 7 pages
- Font size contrast : 제목 52pt / 본문 20pt
- Text per slide : 20-35단어, 비주얼 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Nike 볼드 퍼포먼스 스타일",
    type: "Nike · Bold Athletic Performance",
    colors: ["#111111", "#FA5400", "#BFFF00"],
    cardBg:
      "linear-gradient(135deg, rgba(250,84,0,0.09), rgba(191,255,0,0.06))",
    numBg: "rgba(250,84,0,0.11)",
    numColor: "#c24000",
    prompt: `[NotebookLM Slide Design Guide]

Role : 스포츠 브랜드 매니저
Industry : 스포츠웨어, 애슬레틱 퍼포먼스
Type : 캠페인 발표, 제품 런칭

[Color Guide]
Background : 나이키 블랙(#111111) 또는 화이트(#FFFFFF)
Text Color : 화이트(#FFFFFF) 또는 블랙(#000000), 고대비
Accent : 나이키 오렌지(#FA5400), 볼트 그린(#BFFF00)
Font : Futura Condensed (영문), Noto Sans KR Bold (한글)

[Tone & Manner]
에너제틱하고 동기부여하는 톤. "Just Do It" 정신. 한계 돌파와 도전 강조.

[Image Principles]
다이나믹한 액션 스포츠 사진. 운동선수의 강렬한 순간 포착. 모션 블러와 에너지 표현. 제품 디테일 클로즈업. 고대비 흑백 또는 생생한 컬러. 도시 배경과 스트리트 컬처. 영웅적인 로우 앵글 구도. 땀과 노력의 순간. 스우시 로고의 미니멀한 활용.

[Design Characteristics]
대담하고 다이나믹한 레이아웃. 비대칭적 구성. 강렬한 타이포그래피. 이미지를 관통하는 텍스트.

[Layout Guide]
- Title Slide : 풀블리드 액션 샷, 대형 슬로건 오버레이
- Spec Slide : 제품 이미지 70%, 간결한 성능 설명
- Comparison Slide : 성능 향상 비교, 운동선수 인증
- CTA Slide : "Just Do It" 스타일 강렬한 콜투액션
- Tone : 에너제틱하고 영감을 주는
- Slide count : 7 pages
- Font size contrast : 제목 70pt / 본문 18pt
- Text per slide : 10-20단어, 슬로건 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Starbucks 웜 커뮤니티 스타일",
    type: "Starbucks · Warm Community Brand",
    colors: ["#FFFFFF", "#00704A", "#CBA258"],
    cardBg:
      "linear-gradient(135deg, rgba(0,112,74,0.08), rgba(203,162,88,0.07))",
    numBg: "rgba(0,112,74,0.10)",
    numColor: "#00704A",
    prompt: `[NotebookLM Slide Design Guide]

Role : 브랜드 경험 매니저
Industry : 카페 체인, F&B, 라이프스타일
Type : 시즌 캠페인, 커뮤니티 프로그램

[Color Guide]
Background : 스타벅스 화이트(#FFFFFF) 또는 크림(#F7F2E8)
Text Color : 스타벅스 그린(#00704A), 다크 브라운(#1E3932)
Accent : 시그니처 그린(#00704A), 골드(#CBA258), 시즌 컬러
Font : Sodo Sans (영문), Noto Sans KR (한글)

[Tone & Manner]
따뜻하고 환영하는 톤. 커뮤니티와 연결감 강조. 일상의 특별한 순간 창출.

[Image Principles]
따뜻한 카페 분위기 사진. 음료와 푸드 클로즈업, 식욕을 자극하는 구도. 자연광과 코지한 조명. 다양한 사람들의 진정성 있는 순간. 핸드 드로잉 일러스트 요소. 계절감과 시즌 테마. 커피 원두와 자연 소재. 사이렌 로고의 우아한 활용.

[Design Characteristics]
따뜻하고 초대하는 레이아웃. 원형과 곡선 활용. 유기적 형태. 텍스처와 패턴.

[Layout Guide]
- Title Slide : 음료 이미지 중앙, 시즌 타이틀, 그린 액센트
- Spec Slide : 좌측 음료 사진, 우측 재료와 스토리
- Comparison Slide : 시즌 메뉴 라인업, 각각 특징 설명
- CTA Slide : "Visit us today", 매장 위치 정보
- Tone : 따뜻하고 환영하는
- Slide count : 7 pages
- Font size contrast : 제목 40pt / 본문 20pt / 캡션 16pt
- Text per slide : 25-40단어, 감성적 스토리텔링

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Airbnb 여행 경험 스타일",
    type: "Airbnb · Travel Experience Platform",
    colors: ["#FFFFFF", "#FF385C", "#00A699"],
    cardBg:
      "linear-gradient(135deg, rgba(255,56,92,0.08), rgba(0,166,153,0.06))",
    numBg: "rgba(255,56,92,0.10)",
    numColor: "#d42050",
    prompt: `[NotebookLM Slide Design Guide]

Role : 호스피탈리티 매니저
Industry : 여행, 숙박 공유, 경험 플랫폼
Type : 서비스 소개, 여행 가이드

[Color Guide]
Background : 에어비앤비 화이트(#FFFFFF) 또는 라이트 그레이(#F7F7F7)
Text Color : 에어비앤비 블랙(#222222), 그레이(#717171)
Accent : 에어비앤비 레드(#FF385C), 틸(#00A699)
Font : Cereal (영문), Noto Sans KR (한글)

[Tone & Manner]
따뜻하고 환대하는 톤. "Belong Anywhere" 철학. 진정성 있는 여행 경험 강조.

[Image Principles]
진정성 있는 여행 사진. 다양한 숙소와 공간 이미지. 호스트와 게스트의 자연스러운 순간. 로컬 경험과 문화. 따뜻한 자연광. 인테리어와 디테일 샷. 글로벌 다양성 표현. 경험과 연결 중심 비주얼. 둥근 모서리의 사진 프레임.

[Design Characteristics]
매거진 스타일 레이아웃. 사진 중심 구성. 넓은 여백과 큰 타이포그래피. 스토리텔링 중심.

[Layout Guide]
- Title Slide : 풀블리드 여행지 사진, 하단 타이틀
- Spec Slide : 좌측 숙소 이미지, 우측 편의시설 정보
- Comparison Slide : 다양한 숙소 타입, 경험 중심 비교
- CTA Slide : "Book your next adventure", 예약 링크
- Tone : 따뜻하고 영감을 주는
- Slide count : 7 pages
- Font size contrast : 제목 42pt / 본문 20pt / 캡션 16pt
- Text per slide : 25-40단어, 경험 스토리 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Spotify 뮤직 바이브 스타일",
    type: "Spotify · Music Vibe Platform",
    colors: ["#191414", "#1DB954", "#FFFFFF"],
    cardBg:
      "linear-gradient(135deg, rgba(29,185,84,0.10), rgba(25,20,20,0.06))",
    numBg: "rgba(29,185,84,0.13)",
    numColor: "#14883c",
    prompt: `[NotebookLM Slide Design Guide]

Role : 뮤직 큐레이터
Industry : 음악 스트리밍, 오디오 플랫폼
Type : 플레이리스트 소개, 음악 트렌드 발표

[Color Guide]
Background : 스포티파이 블랙(#191414) 또는 다크 그레이(#121212)
Text Color : 스포티파이 화이트(#FFFFFF), 라이트 그레이(#B3B3B3)
Accent : 스포티파이 그린(#1DB954), 바이브런트 그라데이션
Font : Circular Std (영문), Noto Sans KR (한글)

[Tone & Manner]
에너제틱하고 개인화된 톤. 음악 발견의 즐거움. 감정과 음악의 연결 강조.

[Image Principles]
생생한 그라데이션 배경. 앨범 커버와 아티스트 이미지. 다이나믹한 오디오 비주얼라이제이션. UI 스크린샷과 플레이리스트. 음악 장르별 컬러 코딩. 글로우 효과와 네온 느낌. 감정 표현 추상 비주얼. 다크 모드 중심 디자인.

[Design Characteristics]
다크하고 바이브런트한 레이아웃. 그라데이션과 글로우 효과. 음악 중심 구성. 대담한 타이포그래피.

[Layout Guide]
- Title Slide : 그라데이션 배경, 중앙 플레이리스트 제목
- Spec Slide : 좌측 앨범 커버 그리드, 우측 큐레이션 설명
- Comparison Slide : 플랜별 기능 비교, 그린 하이라이트
- CTA Slide : "Listen now" 버튼, 다운로드 링크
- Tone : 에너제틱하고 개인화된
- Slide count : 7 pages
- Font size contrast : 제목 55pt / 본문 20pt
- Text per slide : 15-25단어, 감성적 카피

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Kakao 프렌들리 플랫폼 스타일",
    type: "Kakao · Friendly Platform Service",
    colors: ["#FEE500", "#3C1E1E", "#191919"],
    cardBg:
      "linear-gradient(135deg, rgba(254,229,0,0.14), rgba(60,30,30,0.05))",
    numBg: "rgba(254,229,0,0.20)",
    numColor: "#7a5000",
    prompt: `[NotebookLM Slide Design Guide]

Role : 플랫폼 서비스 기획자
Industry : 모바일 플랫폼, 메신저, 라이프 서비스
Type : 서비스 소개, 사용자 가이드

[Color Guide]
Background : 카카오 옐로우(#FEE500) 또는 화이트(#FFFFFF)
Text Color : 카카오 브라운(#3C1E1E), 다크 그레이(#444444)
Accent : 다크 그레이(#191919), 포인트 레드(#FF6B6B)
Font : Kakao Regular (한글), Apple SD Gothic Neo (영문)

[Tone & Manner]
친근하고 위트 있는 톤. 일상에 자연스럽게 녹아든 서비스. 사용자 편의성 최우선.

[Image Principles]
카카오프렌즈 캐릭터 활용. 말풍선과 대화창 모티프. 밝고 생기 넘치는 일러스트. 모바일 UI 스크린샷. 라이프스타일 시나리오 표현. 옐로우 포인트 컬러 적극 활용. 이모티콘과 스티커 요소. 따뜻하고 접근하기 쉬운 비주얼.

[Design Characteristics]
친근하고 플레이풀한 레이아웃. 둥근 모서리와 부드러운 형태. 메신저 UI 모티프. 말풍선 스타일 박스.

[Layout Guide]
- Title Slide : 전체 노란 배경, 중앙 굵은 브라운 타이틀
- Spec Slide : 말풍선들이 대화하듯 정보 전달
- Comparison Slide : 캐릭터들이 서로 다른 의견 표현
- CTA Slide : "카카오톡 친구 추가" 버튼 스타일
- Tone : 유쾌하고 친근한
- Slide count : 7 pages
- Font size contrast : 제목 40pt / 본문 20pt
- Text per slide : 20-30단어, 구어체 사용

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Hyundai Motor 미래 모빌리티 스타일",
    type: "Hyundai · Future Mobility Vision",
    colors: ["#FFFFFF", "#002C5F", "#608DBC"],
    cardBg:
      "linear-gradient(135deg, rgba(0,44,95,0.08), rgba(96,141,188,0.06))",
    numBg: "rgba(0,44,95,0.10)",
    numColor: "#002C5F",
    prompt: `[NotebookLM Slide Design Guide]

Role : 미래 모빌리티 전략가
Industry : 자동차, 로보틱스, 스마트 모빌리티
Type : 신차 발표, 기술 비전 공유

[Color Guide]
Background : 현대 화이트(#FFFFFF) 또는 액티브 블루(#002C5F)
Text Color : 딥 네이비(#002C5F), 쿨 그레이(#A6A6A6)
Accent : 퍼포먼스 블루(#608DBC), 웜 그레이(#E4DCD3)
Font : Hyundai Sans (영문), 현대산스 (한글)

[Tone & Manner]
"Progress for Humanity" 철학. 지속가능한 미래 모빌리티. 인간 중심 기술 혁신.

[Image Principles]
파라메트릭 픽셀 패턴 활용. 광활한 도로와 자연 풍경. 유려한 곡선의 차량 실루엣. 미래적 기술 시각화. 도시와 모빌리티의 조화. 깔끔한 스튜디오 조명. 프리미엄 인테리어 디테일. 지속가능성 메시지. 글로벌 브랜드 이미지.

[Design Characteristics]
모던하고 프로그레시브한 레이아웃. 와이드 화면 구성. 선을 활용한 속도감. 픽셀 그래픽 포인트.

[Layout Guide]
- Title Slide : 픽셀 라이트 효과, 차량 실루엣, 모던 제목
- Spec Slide : 차량 측면도 위에 라인으로 스펙 연결
- Comparison Slide : 전통 vs 미래 모빌리티 라이프스타일
- CTA Slide : 끝없는 도로 이미지와 비전 메시지
- Tone : 진취적이고 미래지향적인
- Slide count : 7 pages
- Font size contrast : 제목 38pt / 본문 16pt
- Text per slide : 25-35단어, 비전과 기술 균형

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
];

function renderVipBrands14() {
  const promptArea = document.getElementById("promptArea");
  promptArea.innerHTML = `
    <div class="prompt-header">
      <div class="prompt-header-top">
        <span class="ph-category">⭐ VIP Best Collection</span>
        <span class="ph-arrow">›</span>
        <span class="ph-industry">Brands Best 14</span>
      </div>
      <h2>Brands Best 14 슬라이드 프롬프트</h2>
      <p>글로벌 브랜드 감성을 담은 14가지 프리미엄 디자인 가이드입니다.</p>
    </div>
    <div class="prompt-grid" id="promptGrid"></div>
  `;
  const grid = document.getElementById("promptGrid");
  BRANDS_14.forEach((design, i) => {
    const card = document.createElement("div");
    card.className = "prompt-card";
    card.innerHTML = `
      <div class="card-top">
...
// ── Image Style Best 14 ────────────────────────────────────
export const IMAGE_STYLE_14 = [
  {
    name: "프리미엄 리얼 포토 스타일",
    type: "Real Photo · Brand Presentation",
    colors: ["#FFFFFF", "#111827", "#6B7280"],
    cardBg:
      "linear-gradient(135deg, rgba(17,24,39,0.07), rgba(107,114,128,0.04))",
    numBg: "rgba(17,24,39,0.08)",
    numColor: "#111827",
    prompt: `[NotebookLM Slide Design Guide]

Role : 브랜드 매니저
Industry : 기업 브랜딩, 부동산, 프리미엄 서비스
Type : 회사 소개서, 브랜드 프레젠테이션

[Color Guide]
Background : 퓨어 화이트(#FFFFFF) 또는 소프트 그레이(#F8F9FA)
Text Color : 프로페셔널 블랙(#111827), 서브 그레이(#6B7280)
Accent : 브랜드 메인 컬러 1-2개만 사용
Font : Pretendard (한글), Inter (영문) - Sans-serif 계열

[Tone & Manner]
진정성 있고 신뢰감 있는 톤. 현실적이고 접근 가능한 브랜드 이미지 구축.

[Image Principles]
고해상도 실사 사진 스타일. 자연광과 전문적 조명을 활용한 깨끗한 촬영. 피사계 심도를 이용한 주제 강조. 다양성과 포용성을 반영한 인물 사진. 과도한 보정 지양, 자연스러운 색감 유지. 기업 환경과 현대적 공간 중심. 스톡 사진보다는 브랜드 자체 촬영 느낌.

[Design Characteristics]
풀블리드 이미지 활용. 이미지 위 최소한의 텍스트 오버레이. 충분한 여백과 깔끔한 레이아웃.

[Layout Guide]
- Title Slide : 풀스크린 브랜드 이미지, 하단 타이틀 오버레이
- Spec Slide : 좌측 대형 이미지, 우측 간결한 텍스트
- Comparison Slide : Before/After 실제 상황 사진으로 비교
- CTA Slide : 임팩트 있는 인물 사진, 중앙 메시지
- Tone : 신뢰감 있고 전문적인
- Slide count : 7 pages
- Font size contrast : 제목 42pt / 본문 18pt / 캡션 14pt
- Text per slide : 20-35단어, 이미지가 메인 스토리

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "미니멀 플랫 벡터 스타일",
    type: "Flat Vector · Digital Platform",
    colors: ["#FFFFFF", "#3B82F6", "#10B981"],
    cardBg:
      "linear-gradient(135deg, rgba(59,130,246,0.08), rgba(16,185,129,0.05))",
    numBg: "rgba(59,130,246,0.10)",
    numColor: "#2563EB",
    prompt: `[NotebookLM Slide Design Guide]

Role : UX/UI 디자이너
Industry : IT 서비스, 스타트업, 디지털 플랫폼
Type : 서비스 소개, 기능 설명, 온보딩 자료

[Color Guide]
Background : 클린 화이트(#FFFFFF) 또는 라이트 그레이(#F5F5F5)
Text Color : 다크 네이비(#1E293B), 미디엄 그레이(#64748B)
Accent : 브랜드 프라이머리(#3B82F6), 세컨더리(#10B981), 워닝(#F59E0B)
Font : Pretendard (한글), Inter (영문)

[Tone & Manner]
명확하고 직관적인 톤. 복잡한 개념을 단순하게 전달. 사용자 친화적 접근.

[Image Principles]
완전한 플랫 디자인 벡터 일러스트. 그림자나 그라데이션 없는 단색 블록. 기하학적이고 단순화된 형태. 일관된 선 두께와 모서리 처리. 브랜드 컬러 팔레트 엄격 준수. 메타포와 심볼을 활용한 개념 설명. 아이콘과 일러스트의 통일된 스타일. 화이트 스페이스 적극 활용.

[Design Characteristics]
그리드 기반 정렬. 카드형 레이아웃. 명확한 시각적 위계. 컬러 코딩으로 정보 구분.

[Layout Guide]
- Title Slide : 중앙 서비스 일러스트, 상단 타이틀
- Spec Slide : 3-4개 기능 카드, 각각 아이콘과 설명
- Comparison Slide : 좌우 플랜 비교, 체크리스트 형태
- CTA Slide : 액션 일러스트, 버튼 스타일 CTA
- Tone : 친근하고 명확한
- Slide count : 7 pages
- Font size contrast : 제목 36pt / 서브 24pt / 본문 16pt
- Text per slide : 25-40단어, 핵심 기능 위주

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "3D 아이소메트릭 스타일",
    type: "3D Isometric · System Architecture",
    colors: ["#F1F5F9", "#3B82F6", "#8B5CF6"],
    cardBg:
...
Role : 시스템 아키텍트
Industry : IT 인프라, 물류, 스마트시티
Type : 시스템 구조 설명, 프로세스 플로우

[Color Guide]
Background : 테크 화이트(#FAFBFC) 또는 블루 그레이(#F1F5F9)
Text Color : 시스템 네이비(#0F172A), 라벨 그레이(#475569)
Accent : 테크 블루(#3B82F6), 데이터 퍼플(#8B5CF6), 플로우 틸(#06B6D4)
Font : Pretendard (한글), Roboto (영문)

[Tone & Manner]
기술적이면서 이해하기 쉬운 톤. 복잡한 시스템을 체계적으로 설명.

[Image Principles]
30도 각도의 아이소메트릭 3D 뷰. 깔끔한 기하학적 형태와 정확한 원근법. 플로팅 요소와 연결선으로 관계 표시. 컬러 코딩된 모듈과 컴포넌트. 부드러운 그림자와 입체감. 데이터 흐름을 화살표로 표현. 건물, 서버, 네트워크 등 기술 요소 중심. 일관된 조명과 매터리얼.

[Design Characteristics]
체계적이고 모듈식 구성. 중앙 집중형 다이어그램. 주변 설명 박스 배치.

[Layout Guide]
- Title Slide : 전체 시스템 아이소메트릭 뷰, 상단 타이틀
- Spec Slide : 중앙 3D 다이어그램, 주변 기능 설명
- Comparison Slide : 기존 vs 신규 시스템 아이소메트릭 비교
- CTA Slide : 완성된 구조도, 구현 단계 표시
- Tone : 기술적이고 체계적인
- Slide count : 7 pages
- Font size contrast : 제목 34pt / 라벨 14pt / 본문 16pt
- Text per slide : 30-45단어, 기술 설명 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "인포그래픽 데이터 스타일",
    type: "Infographic Data · Analytics Report",
    colors: ["#FFFFFF", "#3B82F6", "#EF4444"],
    cardBg:
      "linear-gradient(135deg, rgba(59,130,246,0.08), rgba(239,68,68,0.05))",
    numBg: "rgba(59,130,246,0.10)",
    numColor: "#2563EB",
    prompt: `[NotebookLM Slide Design Guide]

Role : 데이터 애널리스트
Industry : 리서치, 컨설팅, 시장조사
Type : 데이터 리포트, 인사이트 발표

[Color Guide]
Background : 데이터 화이트(#FFFFFF)
Text Color : 정보 블랙(#111827), 라벨 그레이(#6B7280)
Accent : 데이터 블루(#3B82F6), 성장 그린(#10B981), 경고 레드(#EF4444)
Font : 맑은 고딕 (한글), Roboto (영문)

[Tone & Manner]
객관적이고 분석적인 톤. 데이터 기반의 명확한 인사이트 전달.

[Image Principles]
명확한 차트와 그래프 (막대, 선, 파이, 산점도). 일관된 컬러 코딩 시스템. 픽토그램과 인포그래픽 아이콘 활용. 수치 강조를 위한 대형 타이포그래피. 플로우차트와 프로세스 다이어그램. 비교 시각화와 트렌드 표시. 깔끔한 범례와 데이터 라벨. 정보 밀도와 가독성의 균형.

[Design Characteristics]
그리드 기반 정확한 정렬. 데이터 중심 레이아웃. 일관된 차트 스타일.

[Layout Guide]
- Title Slide : 핵심 통계 대형 표시, 간결한 헤드라인
- Spec Slide : 메인 차트 중앙 배치, 서포팅 데이터 주변
- Comparison Slide : 멀티 차트 비교, 통일된 스케일
- CTA Slide : 핵심 인사이트 요약, 액션 아이템
- Tone : 객관적이고 신뢰할 수 있는
- Slide count : 7 pages
- Font size contrast : 제목 32pt / 수치 28pt / 라벨 14pt
- Text per slide : 30-50단어, 데이터 컨텍스트 제공

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "수채화 아트 스타일",
    type: "Watercolor Art · Lifestyle Brand",
    colors: ["#FFF8F0", "#FDA4AF", "#93C5FD"],
    cardBg:
      "linear-gradient(135deg, rgba(253,164,175,0.10), rgba(147,197,253,0.08))",
    numBg: "rgba(253,164,175,0.14)",
    numColor: "#be5a6a",
    prompt: `[NotebookLM Slide Design Guide]

Role : 브랜드 아티스트
Industry : 웰니스, 뷰티, 라이프스타일, 교육
Type : 감성 마케팅, 브랜드 스토리

[Color Guide]
Background : 워터컬러 아이보리(#FFF8F0) 또는 소프트 화이트(#FEFEFE)
Text Color : 소프트 차콜(#374151), 세피아 브라운(#78716C)
Accent : 로즈 쿼츠(#FDA4AF), 세레니티(#93C5FD), 민트(#A7F3D0)
Font : Noto Serif KR (한글), Cormorant (영문)

[Tone & Manner]
부드럽고 감성적인 톤. 자연스럽고 따뜻한 브랜드 경험 제공.

[Image Principles]
물의 흐름과 번짐 효과가 있는 수채화 스타일. 투명하고 겹치는 레이어 표현. 부드러운 색상 그라데이션과 자연스러운 경계. 종이 텍스처와 물감의 질감 표현. 손으로 그린 듯한 유기적 형태. 파스텔 톤과 자연색 중심 팔레트. 꽃, 식물, 자연 모티프 활용. 여백과 공간의 예술적 활용.

[Design Characteristics]
유기적이고 흐르는 듯한 레이아웃. 부드러운 모서리와 곡선 활용. 수채화 배경과 텍스처.

[Layout Guide]
- Title Slide : 수채화 플로럴 배경, 중앙 우아한 타이틀
- Spec Slide : 수채화 일러스트 좌측, 우측 부드러운 텍스트
- Comparison Slide : 수채화 경계선 구분, 조화로운 색상
- CTA Slide : 수채화 프레임 안 메시지, 자연 장식
- Tone : 부드럽고 감성적인
- Slide count : 7 pages
- Font size contrast : 제목 38pt / 본문 18pt / 캡션 16pt
- Text per slide : 20-35단어, 감성적 메시지 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "펜 스케치 스타일",
    type: "Pen Sketch · Concept Design",
    colors: ["#FAFAFA", "#1A1A1A", "#FBBF24"],
    cardBg:
      "linear-gradient(135deg, rgba(26,26,26,0.06), rgba(251,191,36,0.08))",
    numBg: "rgba(26,26,26,0.07)",
    numColor: "#1A1A1A",
    prompt: `[NotebookLM Slide Design Guide]

Role : 콘셉트 디자이너
Industry : 건축, 제품 디자인, 창작 스튜디오
Type : 초기 아이디어 발표, 콘셉트 스케치

[Color Guide]
Background : 스케치북 화이트(#FAFAFA) 또는 크림(#FFF9E6)
Text Color : 펜 블랙(#1A1A1A), 연필 그레이(#6B7280)
Accent : 하이라이터 옐로우(#FBBF24), 레드펜(#DC2626)
Font : 나눔손글씨 (한글), Architects Daughter (영문)

[Tone & Manner]
창의적이고 실험적인 톤. 아이디어의 진화 과정을 자연스럽게 표현.

[Image Principles]
손으로 그린 듯한 펜 드로잉과 스케치. 클린한 라인과 해칭 기법 활용. 흑백 또는 제한된 색상 팔레트. 건축 도면과 기술 스케치 느낌. 진행 중인 듯한 언피니시드 룩. 주석과 화살표, 치수 표기. 여러 앵글과 디테일 스터디. 종이 텍스처와 연필 질감 표현.

[Design Characteristics]
스케치북 레이아웃. 비정형적이고 자유로운 배치. 손글씨 스타일 활용.

[Layout Guide]
- Title Slide : 중앙 라인 드로잉, 손글씨 스타일 타이틀
- Spec Slide : 기술 스케치 좌측, 우측 주석 스타일 설명
- Comparison Slide : 스케치 오버레이 비교, 변화 화살표
- CTA Slide : 완성 비전 스케치, 액션 주석
- Tone : 창의적이고 자유로운
- Slide count : 7 pages
- Font size contrast : 제목 36pt / 본문 18pt / 주석 14pt
- Text per slide : 20-40단어, 스케치 중심 설명

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "팝아트 스타일",
    type: "Pop Art · MZ Brand Campaign",
    colors: ["#FBBF24", "#000000", "#3B82F6"],
    cardBg:
      "linear-gradient(135deg, rgba(251,191,36,0.12), rgba(59,130,246,0.08))",
    numBg: "rgba(251,191,36,0.18)",
    numColor: "#92610a",
    prompt: `[NotebookLM Slide Design Guide]

Role : 크리에이티브 디렉터
Industry : 패션, 엔터테인먼트, MZ세대 타겟 브랜드
Type : 캠페인 제안, 트렌드 리포트

[Color Guide]
Background : 비비드 옐로우(#FBBF24) 또는 핫 핑크(#EC4899)
Text Color : 볼드 블랙(#000000), 컨트라스트 화이트(#FFFFFF)
Accent : 일렉트릭 블루(#3B82F6), 네온 그린(#10B981), 파워 레드(#EF4444)
Font : 배민 주아 (한글), Impact (영문)

[Tone & Manner]
대담하고 에너지 넘치는 톤. 강렬하고 기억에 남는 메시지 전달.

[Image Principles]
앤디 워홀 스타일 반복 패턴과 대비 효과. 하프톤 도트와 벤데이 프린팅 질감. 고대비 컬러와 굵은 아웃라인. 만화책 스타일 말풍선과 효과음. 대중 아이콘과 제품의 그래픽적 재해석. 실크스크린 프린트 질감과 레이어. 대담한 컬러 블로킹과 패턴. 그래픽 노벨 미학.

[Design Characteristics]
충격적이고 반복적인 레이아웃. 대칭적 그리드 구성. 강렬한 컬러 조합.

[Layout Guide]
- Title Slide : 4분할 반복 이미지, 각기 다른 컬러 필터
- Spec Slide : 팝아트 배경, 말풍선 스타일 정보 박스
- Comparison Slide : 듀오톤 비교, 만화 효과음 (POW! BAM!)
- CTA Slide : 스타버스트 배경, 강렬한 액션 워드
- Tone : 대담하고 임팩트 있는
- Slide count : 7 pages
- Font size contrast : 제목 48pt / 본문 22pt / 효과음 32pt
- Text per slide : 10-25단어, 슬로건과 키워드 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "빈티지 레트로 스타일",
    type: "Vintage Retro · Heritage Brand",
    colors: ["#F5E6D3", "#78350F", "#EA580C"],
    cardBg:
      "linear-gradient(135deg, rgba(120,53,15,0.09), rgba(234,88,12,0.06))",
    numBg: "rgba(120,53,15,0.10)",
    numColor: "#78350F",
    prompt: `[NotebookLM Slide Design Guide]

Role : 헤리티지 브랜드 매니저
Industry : 전통 브랜드, 수제 제품, 클래식 서비스
Type : 브랜드 히스토리, 헤리티지 마케팅

[Color Guide]
Background : 에이지드 페이퍼(#F5E6D3) 또는 빈티지 크림(#FFF4E6)
Text Color : 클래식 브라운(#78350F), 세피아 블랙(#292524)
Accent : 러스트 오렌지(#EA580C), 올리브 그린(#65A30D), 머스타드(#CA8A04)
Font : 나눔명조 (한글), Playfair Display (영문)

[Tone & Manner]
노스탤직하고 진정성 있는 톤. 시간이 만든 가치와 전통 강조.

[Image Principles]
1950-70년대 광고 미학과 레트로 스타일. 세피아 톤과 페이드 효과. 빈티지 텍스처와 그레인 노이즈. 레트로 타이포그래피와 배지 디자인. 오래된 사진과 클래식 일러스트. 노스탤직한 컬러 팔레트. 손상되고 낡은 효과와 빈티지 프레임. 클래식한 구도와 대칭적 프레이밍.

[Design Characteristics]
전통적이고 대칭적인 레이아웃. 장식적 요소와 보더 활용. 빈티지 라벨과 스탬프 느낌.

[Layout Guide]
- Title Slide : 빈티지 프레임, 중앙 클래식 타이틀, 리본 장식
- Spec Slide : 레트로 배지 좌측, 우측 전통적 텍스트 배치
- Comparison Slide : 타임라인 형식, 빈티지 사진 비교
- CTA Slide : 빈티지 스탬프 스타일, 클래식한 연락처
- Tone : 노스탤직하고 신뢰할 수 있는
- Slide count : 7 pages
- Font size contrast : 제목 40pt / 본문 18pt / 캡션 16pt
- Text per slide : 25-40단어, 스토리텔링 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "Disney Pixar 3D 스타일",
    type: "Disney Pixar 3D · Entertainment",
    colors: ["#E0F2FE", "#EF4444", "#A855F7"],
    cardBg:
      "linear-gradient(135deg, rgba(239,68,68,0.08), rgba(168,85,247,0.06))",
    numBg: "rgba(239,68,68,0.10)",
    numColor: "#dc2626",
    prompt: `[NotebookLM Slide Design Guide]

Role : 콘텐츠 크리에이터
Industry : 엔터테인먼트, 교육, 키즈 브랜드
Type : 애니메이션 프로젝트, 교육 자료

[Color Guide]
Background : 스카이 블루(#E0F2FE) 또는 선샤인 옐로우(#FEF3C7)
Text Color : 카툰 네이비(#1E3A8A), 플레이풀 브라운(#78350F)
Accent : 픽사 레드(#EF4444), 조이 오렌지(#F97316), 매직 퍼플(#A855F7)
Font : 배민 키즈 (한글), Fredoka One (영문)

[Tone & Manner]
재미있고 에너지 넘치는 톤. 모든 연령이 즐길 수 있는 따뜻한 스토리텔링.

[Image Principles]
고품질 3D 렌더링의 픽사 애니메이션 스타일. 과장된 표현과 캐릭터 디자인. 큰 눈과 표현력 풍부한 얼굴. 부드러운 곡선과 라운드 형태. 생생한 색상과 풍부한 텍스처. 극적인 조명과 글로우 효과. 디테일한 환경과 소품. 감정 전달하는 포즈와 제스처. 영화 같은 구도와 카메라 워크.

[Design Characteristics]
플레이풀하고 다이나믹한 레이아웃. 캐릭터 중심 구성. 스토리보드 느낌.

[Layout Guide]
- Title Slide : 히어로 캐릭터 중앙, 로고 스타일 타이틀
- Spec Slide : 캐릭터 액션 좌측, 우측 말풍선 설명
- Comparison Slide : 캐릭터 표정/상황 비교, 만화적 대비
- CTA Slide : 캐릭터 그룹 샷, 초대하는 포즈
- Tone : 재미있고 따뜻한
- Slide count : 7 pages
- Font size contrast : 제목 44pt / 본문 20pt / 말풍선 18pt
- Text per slide : 15-30단어, 대화체 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "글래스모피즘 스타일",
    type: "Glassmorphism · Fintech UI",
    colors: ["#DBEAFE", "#06B6D4", "#EC4899"],
    cardBg:
      "linear-gradient(135deg, rgba(6,182,212,0.10), rgba(236,72,153,0.07))",
    numBg: "rgba(6,182,212,0.12)",
    numColor: "#0891b2",
    prompt: `[NotebookLM Slide Design Guide]

Role : UI/UX 디자이너
Industry : 핀테크, 모바일 앱, 현대적 서비스
Type : 앱 소개, UI 쇼케이스

[Color Guide]
Background : 그라데이션 블루(#DBEAFE → #3B82F6) 또는 퍼플(#F3E8FF → #8B5CF6)
Text Color : 글래스 화이트(#FFFFFF), 소프트 그레이(#E5E7EB)
Accent : 네온 시안(#06B6D4), 글로우 핑크(#EC4899), 라이트 옐로우(#FDE047)
Font : Pretendard (한글), SF Pro Display (영문)

[Tone & Manner]
모던하고 미래지향적인 톤. 세련되고 혁신적인 기술 이미지.

[Image Principles]
반투명 유리 효과와 배경 블러 처리. 프로스티드 글래스 텍스처와 투명도. 플로팅 카드와 레이어드 인터페이스. 서브틀한 화이트 보더와 글로우 효과. 생생한 배경 그라데이션이 비치는 효과. 부드러운 그림자와 깊이감. 클린하고 모던한 UI 요소. 에어리하고 스페이셜한 구성.

[Design Characteristics]
레이어드 인터페이스 디자인. 투명도를 활용한 깊이감. 미니멀하면서 럭셔리한 느낌.

[Layout Guide]
- Title Slide : 글래스 카드 중앙, 백그라운드 그라데이션
- Spec Slide : 플로팅 글래스 패널들, 각기 다른 투명도
- Comparison Slide : 좌우 글래스 카드 비교, 컬러 구분
- CTA Slide : 중앙 글래스 버튼, 글로우 효과
- Tone : 모던하고 프리미엄한
- Slide count : 7 pages
- Font size contrast : 제목 40pt / 본문 18pt / 라벨 14pt
- Text per slide : 20-35단어, 간결하고 임팩트 있게

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "사이버펑크 네온 스타일",
    type: "Cyberpunk Neon · Game · Blockchain",
    colors: ["#020617", "#22D3EE", "#8B5CF6"],
    cardBg:
      "linear-gradient(135deg, rgba(34,211,238,0.10), rgba(139,92,246,0.08))",
    numBg: "rgba(34,211,238,0.12)",
    numColor: "#0e9ab8",
    prompt: `[NotebookLM Slide Design Guide]

Role : 게임 디렉터
Industry : 게임, 블록체인, AI 기술
Type : 게임 콘셉트, 미래 기술 소개

[Color Guide]
Background : 사이버 블랙(#020617) 또는 딥 퍼플(#1E1B4B)
Text Color : 네온 시안(#22D3EE), 일렉트릭 핑크(#FB37FF)
Accent : 바이올렛(#8B5CF6), 애시드 그린(#A3E635), 네온 옐로우(#FBBF24)
Font : 나눔고딕 코딩 (한글), Space Mono (영문)

[Tone & Manner]
다크하지만 에너제틱한 톤. 미래적이고 하이테크한 분위기.

[Image Principles]
미래적 사이버펑크 미학과 네온 조명. 어두운 배경에 밝은 네온 라이트 (시안, 마젠타, 퍼플). 글리치 효과와 홀로그램 느낌. 하이테크 그리드 패턴과 와이어프레임. 글로우 효과와 네온 아웃라인. 야간 도시 스카이라인과 디지털 노이즈. 메탈릭 텍스처와 반사 효과. 디스토피안하지만 매혹적인 분위기.

[Design Characteristics]
다크 모드 UI 스타일. 네온 보더와 글로우 효과. 그리드 패턴 배경.

[Layout Guide]
- Title Slide : 네온 로고 중앙, 글로우 효과
- Spec Slide : 좌측 텍스트, 우측 사이버 일러스트
- Comparison Slide : 기존/미래 콘셉트, 색톤으로 구분
- CTA Slide : 네온 버튼 스타일, "ENTER" 메시지
- Tone : 다크하고 미래적인
- Slide count : 7 pages
- Font size contrast : 제목 42pt / 본문 18pt / 이펙트 텍스트 24pt
- Text per slide : 15-30단어, 키워드 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "로우폴리 3D 스타일",
    type: "Low Poly 3D · Modern Brand",
    colors: ["#F3F4F6", "#3B82F6", "#10B981"],
    cardBg:
...
Role : 3D 아티스트
Industry : 게임, 인테리어, 모던 브랜드
Type : 3D 모델링 쇼케이스, 공간 디자인

[Color Guide]
Background : 미니멀 화이트(#FFFFFF) 또는 그라데이션 그레이(#F3F4F6 → #E5E7EB)
Text Color : 모던 블랙(#0A0A0A), 미드 그레이(#6B7280)
Accent : 크리스탈 블루(#3B82F6), 에메랄드(#10B981), 코랄(#F97316)
Font : Pretendard (한글), Poppins (영문)

[Tone & Manner]
모던하고 미니멀한 톤. 기하학적 아름다움과 단순함 강조.

[Image Principles]
로우폴리 기하학적 3D 아트 스타일. 삼각형 면으로 구성된 오브젝트. 날카로운 모서리와 플랫 셰이딩. 추상적이고 디지털적인 미학. 생생한 컬러 팔레트와 크리스탈라인 룩. 미니멀하지만 기하학을 통한 디테일. 일관된 조명과 그림자 처리. 플로팅 요소와 공간감.

[Design Characteristics]
기하학적 레이아웃. 3D 요소와 타이포그래피 조화. 미니멀한 구성.

[Layout Guide]
- Title Slide : 중앙 로우폴리 오브젝트, 미니멀 타이틀
- Spec Slide : 3D 모델 좌측, 우측 깔끔한 스펙
- Comparison Slide : 여러 각도 로우폴리 뷰
- CTA Slide : 3D 아이콘과 모던한 CTA
- Tone : 모던하고 기하학적인
- Slide count : 7 pages
- Font size contrast : 제목 38pt / 본문 18pt / 라벨 14pt
- Text per slide : 20-35단어, 간결하고 모던하게

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "페이퍼 컷아웃 스타일",
    type: "Paper Cutout · Education & Kids",
    colors: ["#FEFEFE", "#DC143C", "#4169E1"],
    cardBg:
      "linear-gradient(135deg, rgba(220,20,60,0.08), rgba(65,105,225,0.06))",
    numBg: "rgba(220,20,60,0.10)",
    numColor: "#b01030",
    prompt: `[NotebookLM Slide Design Guide]

Role : 교육 콘텐츠 디자이너
Industry : 교육, 아동 도서, 공예
Type : 교육 자료, 스토리텔링

[Color Guide]
Background : 페이퍼 화이트(#FEFEFE) 또는 크래프트(#F5F5DC)
Text Color : 페이퍼 블랙(#2D2D2D), 브라운(#8B4513)
Accent : 페이퍼 레드(#DC143C), 페이퍼 블루(#4169E1), 페이퍼 그린(#228B22)
Font : 나눔바른펜 (한글), Fredoka One (영문)

[Tone & Manner]
따뜻하고 친근한 톤. 수제 느낌의 정성스러운 접근.

[Image Principles]
레이어드 페이퍼 컷아웃 아트 스타일. 종이를 겹겹이 쌓아 만든 입체감. 각 레이어 간의 현실적인 그림자. 종이 질감과 그레인 표현. 컷아웃 엣지의 자연스러운 처리. 플레이풀한 컬러 페이퍼 사용. 손으로 만든 듯한 크래프트 느낌. 따뜻하고 촉각적인 질감.

[Design Characteristics]
레이어드 구성. 수작업 느낌의 배치. 따뜻한 그림자와 깊이감.

[Layout Guide]
- Title Slide : 페이퍼 컷아웃 타이틀, 레이어드 배경
- Spec Slide : 컷아웃 일러스트 좌측, 우측 텍스트 카드
- Comparison Slide : 좌우 페이퍼 씬 비교
- CTA Slide : 페이퍼 버튼 스타일, 손글씨 느낌
- Tone : 따뜻하고 친근한
- Slide count : 7 pages
- Font size contrast : 제목 36pt / 본문 18pt / 캡션 16pt
- Text per slide : 25-40단어, 스토리 중심

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    name: "클레이 3D 스타일",
    type: "Clay 3D · MZ Casual Brand",
    colors: ["#F5F5DC", "#FFB347", "#98FB98"],
    cardBg:
      "linear-gradient(135deg, rgba(255,179,71,0.10), rgba(152,251,152,0.08))",
    numBg: "rgba(255,179,71,0.14)",
    numColor: "#b07820",
    prompt: `[NotebookLM Slide Design Guide]

Role : 브랜드 디자이너
Industry : 트렌디 스타트업, MZ세대 브랜드, 캐주얼 서비스
Type : 브랜드 소개, 캐주얼 프레젠테이션

[Color Guide]
Background : 클레이 베이지(#F5F5DC) 또는 소프트 핑크(#FFE4E1)
Text Color : 클레이 브라운(#8B4513), 소프트 블랙(#2F2F2F)
Accent : 파스텔 오렌지(#FFB347), 민트(#98FB98), 라벤더(#E6E6FA)
Font : Pretendard (한글), Nunito (영문)

[Tone & Manner]
플레이풀하고 접근하기 쉬운 톤. 친근하고 트렌디한 브랜드 이미지.

[Image Principles]
소프트 모델링 클레이로 만든 듯한 3D 스타일. 매트 피니시와 부드러운 텍스처. 라운드 엣지와 퍼피한 형태. 단순하고 미니멀한 디테일. 파스텔 컬러와 소프트 톤. 촉각적이고 스퀴시한 느낌. 플레이풀한 캐릭터와 오브젝트. 부드러운 조명과 앰비언트 셰이딩.

[Design Characteristics]
소프트하고 라운드한 레이아웃. 플레이풀한 배치. 트렌디한 구성.

[Layout Guide]
- Title Slide : 클레이 캐릭터 중앙, 소프트 타이틀
- Spec Slide : 클레이 오브젝트들, 카드 형태 설명
- Comparison Slide : 클레이 씬 좌우 비교
- CTA Slide : 클레이 버튼, 친근한 메시지
- Tone : 플레이풀하고 트렌디한
- Slide count : 7 pages
- Font size contrast : 제목 40pt / 본문 18pt / 캡션 16pt
- Text per slide : 20-35단어, 친근한 톤

Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
];

function renderVipImage14() {
  const promptArea = document.getElementById("promptArea");
  promptArea.innerHTML = `
    <div class="prompt-header">
      <div class="prompt-header-top">
        <span class="ph-category">⭐ VIP Best Collection</span>
        <span class="ph-arrow">›</span>
        <span class="ph-industry">Image Style Best 14</span>
      </div>
      <h2>Image Style Best 14 슬라이드 프롬프트</h2>
      <p>시각적 임팩트를 극대화하는 14가지 이미지 스타일 컬렉션입니다.</p>
    </div>
    <div class="prompt-grid" id="promptGrid"></div>
  `;
  const grid = document.getElementById("promptGrid");
  IMAGE_STYLE_14.forEach((design, i) => {
    const card = document.createElement("div");
    card.className = "prompt-card";
    card.innerHTML = `
      <div class="card-top">
  ...
  promptArea.innerHTML = `
    <div class="prompt-header">
      <div class="prompt-header-top">
        <span class="ph-category">⭐ VIP Best Collection</span>
        <span class="ph-arrow">›</span>
        <span class="ph-industry">Designer Best 7</span>
      </div>
      <h2>Designer Best 7 슬라이드 프롬프트</h2>
      <p>전문 디자이너가 엄선한 7가지 최고의 슬라이드 디자인 스타일입니다.</p>
    </div>
    <div class="prompt-grid" id="promptGrid"></div>
  `;
  const grid = document.getElementById("promptGrid");
  DESIGNER_BEST_7.forEach((design, i) => {
    const card = document.createElement("div");
    card.className = "prompt-card";
    card.innerHTML = `
      <div class="card-top">
...
export const SEMICONDUCTOR_PROMPTS = [
  {
    name: "첨단 블루프린트",
    type: "High-Tech Circuit Blueprint",
    colors: ["#0a0e1a", "#00d4ff", "#0052cc"],
    cardBg:
      "linear-gradient(135deg, rgba(0,212,255,0.08), rgba(0,82,204,0.08))",
    numBg: "rgba(0,212,255,0.12)",
    numColor: "#00d4ff",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,0,255,0.08), rgba(0,255,170,0.06))",
    numBg: "rgba(255,0,255,0.12)",
    numColor: "#cc00cc",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,214,10,0.08), rgba(0,18,51,0.05))",
    numBg: "rgba(255,214,10,0.12)",
    numColor: "#8a7200",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 자동차 전용 7개 디자인 프롬프트 ─────────────────────────
export const AUTOMOTIVE_PROMPTS = [
  {
    name: "스피드 다이나믹스",
    type: "Speed Dynamics Launch",
    colors: ["#0a0a0a", "#ff3b30", "#c0c0c0"],
    cardBg:
      "linear-gradient(135deg, rgba(255,59,48,0.08), rgba(20,20,20,0.05))",
    numBg: "rgba(255,59,48,0.12)",
    numColor: "#ff3b30",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(212,175,55,0.08), rgba(12,12,12,0.05))",
    numBg: "rgba(212,175,55,0.12)",
    numColor: "#b8962e",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(124,58,237,0.08), rgba(0,212,255,0.06))",
...
// ── 병원 전용 7개 디자인 프롬프트 ─────────────────────────
export const HOSPITAL_PROMPTS = [
  {
    name: "클린 메디컬 트러스트",
    type: "Clean Medical Trust",
    colors: ["#ffffff", "#0077cc", "#34c759"],
    cardBg: "linear-gradient(135deg, #e8f4ff, #f0f8ff)",
    numBg: "rgba(0,119,204,0.10)",
    numColor: "#0077cc",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(232,133,92,0.08), rgba(255,245,240,0.8))",
    numBg: "rgba(232,133,92,0.12)",
    numColor: "#c06030",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,188,212,0.08), rgba(124,58,237,0.06))",
    numBg: "rgba(0,188,212,0.12)",
    numColor: "#0097a7",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,134,171,0.08), rgba(6,214,160,0.06))",
    numBg: "rgba(46,134,171,0.12)",
    numColor: "#1a6a8a",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,51,102,0.08), rgba(196,30,58,0.04))",
    numBg: "rgba(0,51,102,0.10)",
    numColor: "#003366",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,111,168,0.08), rgba(0,200,150,0.06))",
    numBg: "rgba(26,111,168,0.10)",
    numColor: "#1a6fa8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(245,127,23,0.08), rgba(255,253,231,0.8))",
    numBg: "rgba(245,127,23,0.12)",
    numColor: "#c46000",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(45,106,63,0.08), rgba(201,162,39,0.06))",
    numBg: "rgba(45,106,63,0.10)",
    numColor: "#2d6a3f",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(85,139,47,0.08), rgba(241,248,233,0.8))",
    numBg: "rgba(85,139,47,0.12)",
    numColor: "#4a7a28",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(136,14,79,0.06), rgba(252,228,236,0.8))",
    numBg: "rgba(136,14,79,0.10)",
    numColor: "#880e4f",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,58,108,0.08), rgba(230,57,70,0.06))",
    numBg: "rgba(230,57,70,0.12)",
    numColor: "#c42030",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(21,101,192,0.08), rgba(255,152,0,0.06))",
    numBg: "rgba(21,101,192,0.10)",
    numColor: "#1565c0",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(106,27,154,0.08), rgba(67,160,71,0.06))",
    numBg: "rgba(106,27,154,0.10)",
    numColor: "#6a1b9a",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 약국 전용 7개 디자인 프롬프트 ─────────────────────────
export const PHARMACY_PROMPTS = [
  {
    name: "클린 파마씨 블루",
    type: "Clean Pharmacy Blue",
    colors: ["#e8f4fd", "#0077cc", "#34c759"],
    cardBg:
      "linear-gradient(135deg, rgba(0,119,204,0.08), rgba(52,199,89,0.06))",
    numBg: "rgba(0,119,204,0.10)",
    numColor: "#0077cc",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(194,24,91,0.07), rgba(252,228,236,0.8))",
    numBg: "rgba(194,24,91,0.10)",
    numColor: "#c2185b",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(230,81,0,0.07), rgba(255,248,225,0.8))",
    numBg: "rgba(230,81,0,0.12)",
    numColor: "#bf4000",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,115,232,0.08), rgba(0,200,150,0.06))",
    numBg: "rgba(26,115,232,0.10)",
    numColor: "#1a73e8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,172,193,0.08), rgba(243,243,243,0.8))",
    numBg: "rgba(0,172,193,0.12)",
    numColor: "#007c91",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.08), rgba(255,143,0,0.06))",
    numBg: "rgba(46,125,50,0.12)",
    numColor: "#2e7d32",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 은행 전용 7개 디자인 프롬프트 ─────────────────────────
export const BANK_PROMPTS = [
  {
    name: "트러스트 파이낸셜",
    type: "Trust Financial",
    colors: ["#ffffff", "#003d82", "#0066cc"],
    cardBg: "linear-gradient(135deg, #e8f2ff, #f0f7ff)",
    numBg: "rgba(0,61,130,0.10)",
    numColor: "#003d82",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.10), rgba(12,12,12,0.06))",
    numBg: "rgba(201,168,76,0.14)",
    numColor: "#9a7a20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,102,204,0.08), rgba(245,245,247,0.8))",
    numBg: "rgba(0,102,204,0.10)",
    numColor: "#0066cc",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,255,136,0.07), rgba(255,107,53,0.06))",
    numBg: "rgba(0,255,136,0.10)",
    numColor: "#00cc66",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,143,0,0.08), rgba(21,101,192,0.06))",
    numBg: "rgba(255,143,0,0.12)",
    numColor: "#e65100",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 증권 전용 7개 디자인 프롬프트 ─────────────────────────
export const SECURITIES_PROMPTS = [
  {
    name: "불마켓 모멘텀",
    type: "Bull Market Momentum",
    colors: ["#0a0e1a", "#00e676", "#ffd600"],
    cardBg:
      "linear-gradient(135deg, rgba(0,230,118,0.08), rgba(255,214,0,0.06))",
    numBg: "rgba(0,230,118,0.10)",
    numColor: "#00b050",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#f5f5f7", "#1d1d1f", "#0066cc"],
    cardBg:
      "linear-gradient(135deg, rgba(0,102,204,0.07), rgba(245,245,247,0.8))",
    numBg: "rgba(0,102,204,0.10)",
    numColor: "#0066cc",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,87,168,0.08), rgba(0,191,165,0.06))",
    numBg: "rgba(0,87,168,0.10)",
    numColor: "#0057a8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(212,175,55,0.09), rgba(12,12,20,0.06))",
    numBg: "rgba(212,175,55,0.13)",
    numColor: "#9a7a18",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(124,58,237,0.08), rgba(0,255,204,0.06))",
    numBg: "rgba(124,58,237,0.12)",
    numColor: "#7c3aed",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,214,10,0.08), rgba(68,136,255,0.06))",
    numBg: "rgba(255,214,10,0.12)",
    numColor: "#8a7200",
    prompt: `[NotebookLM Slide Design Guide]
...
export const SOFTWARE_PROMPTS = [
  {
    name: "SaaS 프로덕트 런칭",
    type: "SaaS Product Launch",
    colors: ["#0d0d1a", "#6c63ff", "#00f5c4"],
    cardBg:
      "linear-gradient(135deg, rgba(108,99,255,0.09), rgba(0,245,196,0.06))",
    numBg: "rgba(108,99,255,0.12)",
    numColor: "#6c63ff",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(88,166,255,0.08), rgba(13,17,23,0.05))",
    numBg: "rgba(88,166,255,0.12)",
    numColor: "#2080d0",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(108,99,255,0.08), rgba(255,255,255,0.8))",
    numBg: "rgba(108,99,255,0.10)",
    numColor: "#6c63ff",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,87,168,0.08), rgba(255,149,0,0.06))",
    numBg: "rgba(0,87,168,0.10)",
    numColor: "#0057a8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,255,136,0.07), rgba(255,59,48,0.05))",
    numBg: "rgba(0,255,136,0.10)",
    numColor: "#00cc66",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(108,99,255,0.08), rgba(245,245,247,0.8))",
    numBg: "rgba(108,99,255,0.10)",
    numColor: "#6c63ff",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 앱개발 전용 7개 디자인 프롬프트 ─────────────────────────
export const APPDEV_PROMPTS = [
  {
    name: "앱 런칭 키노트",
    type: "App Launch Keynote",
    colors: ["#0d0d1a", "#ff6b35", "#ffd60a"],
    cardBg:
      "linear-gradient(135deg, rgba(255,107,53,0.09), rgba(255,214,10,0.06))",
    numBg: "rgba(255,107,53,0.12)",
    numColor: "#cc4400",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(108,99,255,0.08), rgba(250,250,250,0.8))",
    numBg: "rgba(108,99,255,0.10)",
    numColor: "#6c63ff",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,200,255,0.08), rgba(124,58,237,0.06))",
    numBg: "rgba(0,200,255,0.12)",
    numColor: "#0097c8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,115,232,0.08), rgba(52,199,89,0.06))",
    numBg: "rgba(26,115,232,0.10)",
    numColor: "#1a73e8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(155,89,182,0.09), rgba(26,188,156,0.06))",
    numBg: "rgba(155,89,182,0.12)",
    numColor: "#7d3c98",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.09), rgba(21,101,192,0.06))",
    numBg: "rgba(46,125,50,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,107,53,0.08), rgba(255,255,255,0.8))",
    numBg: "rgba(255,107,53,0.10)",
    numColor: "#cc4400",
    prompt: `[NotebookLM Slide Design Guide]
...
export const AI_PROMPTS = [
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(124,58,237,0.09), rgba(0,229,255,0.06))",
    numBg: "rgba(124,58,237,0.12)",
    numColor: "#7c3aed",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(13,71,161,0.08), rgba(124,58,237,0.06))",
    numBg: "rgba(13,71,161,0.10)",
    numColor: "#0d47a1",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(124,58,237,0.08), rgba(245,245,247,0.8))",
    numBg: "rgba(124,58,237,0.10)",
    numColor: "#7c3aed",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(124,58,237,0.09), rgba(255,255,255,0.8))",
    numBg: "rgba(124,58,237,0.12)",
    numColor: "#7c3aed",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.09), rgba(124,58,237,0.06))",
    numBg: "rgba(46,125,50,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,200,255,0.08), rgba(255,149,0,0.06))",
    numBg: "rgba(0,200,255,0.12)",
    numColor: "#0097c8",
    prompt: `[NotebookLM Slide Design Guide]
...
export const FASHION_PROMPTS = [
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.09), rgba(10,10,10,0.06))",
    numBg: "rgba(201,168,76,0.13)",
    numColor: "#9a7a20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,59,48,0.09), rgba(255,214,0,0.06))",
    numBg: "rgba(255,59,48,0.12)",
    numColor: "#cc2010",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(176,160,144,0.09), rgba(248,248,248,0.8))",
    numBg: "rgba(29,29,31,0.07)",
    numColor: "#1d1d1f",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(233,30,99,0.09), rgba(255,214,0,0.06))",
    numBg: "rgba(233,30,99,0.12)",
    numColor: "#c2185b",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.09), rgba(121,85,72,0.06))",
    numBg: "rgba(46,125,50,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(233,30,99,0.08), rgba(252,228,236,0.8))",
    numBg: "rgba(233,30,99,0.10)",
    numColor: "#c2185b",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(233,30,99,0.07), rgba(245,245,247,0.8))",
    numBg: "rgba(233,30,99,0.10)",
    numColor: "#c2185b",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 화장품 전용 7개 디자인 프롬프트 ─────────────────────────
export const COSMETICS_PROMPTS = [
  {
    name: "클린뷰티 내추럴",
    type: "Clean Beauty Natural",
    colors: ["#fdf6e8", "#5a3e2b", "#a8c97f"],
    cardBg:
      "linear-gradient(135deg, rgba(168,201,127,0.10), rgba(253,246,232,0.8))",
    numBg: "rgba(90,62,43,0.09)",
    numColor: "#5a3e2b",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,107,157,0.09), rgba(255,214,0,0.06))",
    numBg: "rgba(255,107,157,0.12)",
    numColor: "#cc3366",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#0c0c14", "#d4af37", "#f5f5f0"],
    cardBg:
      "linear-gradient(135deg, rgba(212,175,55,0.10), rgba(12,12,20,0.06))",
    numBg: "rgba(212,175,55,0.14)",
    numColor: "#9a7a18",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(233,30,99,0.08), rgba(255,152,0,0.06))",
    numBg: "rgba(233,30,99,0.10)",
    numColor: "#c2185b",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(13,71,161,0.08), rgba(52,199,89,0.06))",
    numBg: "rgba(13,71,161,0.10)",
    numColor: "#0d47a1",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(156,39,176,0.08), rgba(255,107,157,0.06))",
    numBg: "rgba(156,39,176,0.10)",
    numColor: "#7b1fa2",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(233,30,99,0.07), rgba(255,255,255,0.8))",
    numBg: "rgba(233,30,99,0.09)",
    numColor: "#c2185b",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 미용실 전용 7개 디자인 프롬프트 ─────────────────────────
export const SALON_PROMPTS = [
  {
    name: "프리미엄 살롱 블랙",
    type: "Premium Salon Black",
    colors: ["#0a0a0a", "#c9a84c", "#f5f5f0"],
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.10), rgba(10,10,10,0.06))",
    numBg: "rgba(201,168,76,0.13)",
    numColor: "#9a7a18",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#fff8e1", "#ff8f00", "#1565c0"],
    cardBg:
      "linear-gradient(135deg, rgba(255,143,0,0.09), rgba(21,101,192,0.06))",
    numBg: "rgba(255,143,0,0.12)",
    numColor: "#e65100",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.10), rgba(26,26,46,0.06))",
    numBg: "rgba(201,168,76,0.13)",
    numColor: "#9a7a18",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,115,232,0.08), rgba(201,168,76,0.06))",
    numBg: "rgba(26,115,232,0.10)",
    numColor: "#1a73e8",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 농협 전용 7개 디자인 프롬프트 ─────────────────────────
export const NONGHYUP_PROMPTS = [
  {
    name: "농협 공익 신뢰",
    type: "NH Public Trust",
    colors: ["#ffffff", "#1b6b2f", "#f5c400"],
    cardBg:
      "linear-gradient(135deg, rgba(27,107,47,0.09), rgba(245,196,0,0.06))",
    numBg: "rgba(27,107,47,0.10)",
    numColor: "#1b6b2f",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(27,107,47,0.09), rgba(0,87,168,0.06))",
    numBg: "rgba(27,107,47,0.11)",
    numColor: "#1b6b2f",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(245,127,23,0.09), rgba(46,125,50,0.06))",
    numBg: "rgba(245,127,23,0.12)",
    numColor: "#e65100",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(85,139,47,0.09), rgba(255,143,0,0.06))",
    numBg: "rgba(85,139,47,0.11)",
    numColor: "#4a7a28",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.08), rgba(245,245,247,0.8))",
    numBg: "rgba(46,125,50,0.10)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,115,232,0.08), rgba(46,125,50,0.06))",
    numBg: "rgba(26,115,232,0.10)",
    numColor: "#1a73e8",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 스마트팜 전용 7개 디자인 프롬프트 ─────────────────────────
export const SMARTFARM_PROMPTS = [
  {
    name: "스마트팜 테크 런칭",
    type: "Smart Farm Tech Launch",
    colors: ["#0a1628", "#00c896", "#a8e063"],
    cardBg:
      "linear-gradient(135deg, rgba(0,200,150,0.09), rgba(168,224,99,0.06))",
    numBg: "rgba(0,200,150,0.12)",
    numColor: "#009a72",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(57,211,83,0.09), rgba(184,240,160,0.06))",
    numBg: "rgba(57,211,83,0.12)",
    numColor: "#1e9a36",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(27,107,47,0.09), rgba(0,102,204,0.06))",
    numBg: "rgba(27,107,47,0.11)",
    numColor: "#1b6b2f",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,200,150,0.08), rgba(245,245,247,0.8))",
    numBg: "rgba(0,200,150,0.10)",
    numColor: "#009a72",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,143,0,0.09), rgba(27,107,47,0.06))",
    numBg: "rgba(255,143,0,0.12)",
    numColor: "#e65100",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,200,150,0.09), rgba(255,214,0,0.06))",
    numBg: "rgba(0,200,150,0.12)",
    numColor: "#009a72",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 지자체 전용 7개 디자인 프롬프트 ─────────────────────────
export const LOCALG_PROMPTS = [
  {
    name: "시정 성과 공식 보고",
    type: "Municipal Performance Report",
    colors: ["#ffffff", "#003d82", "#0066cc"],
    cardBg:
      "linear-gradient(135deg, rgba(0,61,130,0.08), rgba(0,102,204,0.05))",
    numBg: "rgba(0,61,130,0.10)",
    numColor: "#003d82",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.10), rgba(0,102,204,0.06))",
    numBg: "rgba(201,168,76,0.13)",
    numColor: "#9a7a20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#fff8e1", "#e65100", "#1565c0"],
    cardBg:
      "linear-gradient(135deg, rgba(230,81,0,0.08), rgba(21,101,192,0.06))",
    numBg: "rgba(230,81,0,0.10)",
    numColor: "#bf4000",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,61,130,0.08), rgba(245,245,247,0.8))",
    numBg: "rgba(0,61,130,0.10)",
    numColor: "#003d82",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,115,232,0.08), rgba(124,58,237,0.06))",
    numBg: "rgba(26,115,232,0.10)",
    numColor: "#1a73e8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,143,0,0.09), rgba(0,61,130,0.06))",
    numBg: "rgba(255,143,0,0.12)",
    numColor: "#e65100",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(52,199,89,0.08), rgba(245,245,247,0.8))",
    numBg: "rgba(52,199,89,0.10)",
    numColor: "#1e9a3a",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,115,232,0.08), rgba(255,149,0,0.06))",
    numBg: "rgba(26,115,232,0.10)",
    numColor: "#1a73e8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,102,204,0.09), rgba(255,107,0,0.06))",
    numBg: "rgba(0,102,204,0.12)",
    numColor: "#0050a0",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(233,30,99,0.07), rgba(201,168,76,0.06))",
    numBg: "rgba(233,30,99,0.09)",
    numColor: "#c2185b",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(168,201,127,0.09), rgba(250,246,240,0.8))",
    numBg: "rgba(92,58,30,0.09)",
    numColor: "#5c3a1e",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.09), rgba(0,102,204,0.06))",
    numBg: "rgba(46,125,50,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(233,30,99,0.08), rgba(21,101,192,0.06))",
    numBg: "rgba(233,30,99,0.10)",
    numColor: "#c2185b",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.09), rgba(0,87,168,0.06))",
    numBg: "rgba(46,125,50,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.08), rgba(255,255,255,0.8))",
    numBg: "rgba(29,29,31,0.07)",
    numColor: "#1d1d1f",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(27,94,32,0.09), rgba(121,85,72,0.06))",
    numBg: "rgba(27,94,32,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,200,255,0.08), rgba(52,199,89,0.06))",
    numBg: "rgba(0,200,255,0.12)",
    numColor: "#0097c8",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 항공 전용 7개 디자인 프롬프트 ─────────────────────────
export const AIRLINE_PROMPTS = [
  {
    name: "풀서비스 항공 프레스티지",
    type: "Full Service Airline Prestige",
    colors: ["#001233", "#c9a84c", "#f5f5f0"],
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.10), rgba(0,18,51,0.06))",
    numBg: "rgba(201,168,76,0.13)",
    numColor: "#9a7a18",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,107,0,0.09), rgba(21,101,192,0.06))",
    numBg: "rgba(255,107,0,0.12)",
    numColor: "#cc5500",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,18,51,0.08), rgba(201,168,76,0.06))",
    numBg: "rgba(0,18,51,0.10)",
    numColor: "#001233",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(156,39,176,0.08), rgba(255,107,0,0.06))",
    numBg: "rgba(156,39,176,0.10)",
    numColor: "#7b1fa2",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 복지관 전용 7개 디자인 프롬프트 ─────────────────────────
export const WELFARE_PROMPTS = [
  {
    name: "따뜻한 돌봄 공동체",
    type: "Warm Care Community",
    colors: ["#fff8e1", "#ff8f00", "#2e7d32"],
    cardBg:
      "linear-gradient(135deg, rgba(255,143,0,0.09), rgba(46,125,50,0.06))",
    numBg: "rgba(255,143,0,0.12)",
    numColor: "#e65100",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(122,74,0,0.09), rgba(21,101,192,0.06))",
    numBg: "rgba(122,74,0,0.10)",
    numColor: "#7a4a00",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(124,58,237,0.08), rgba(52,199,89,0.06))",
    numBg: "rgba(124,58,237,0.10)",
    numColor: "#7c3aed",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 수산시장 전용 7개 디자인 프롬프트 ─────────────────────────
export const FISHMARKET_PROMPTS = [
  {
    name: "새벽 어시장 활력",
    type: "Dawn Fish Market Energy",
    colors: ["#0a1a2e", "#00a8e8", "#ff6b00"],
    cardBg:
      "linear-gradient(135deg, rgba(0,168,232,0.09), rgba(255,107,0,0.06))",
    numBg: "rgba(0,168,232,0.12)",
    numColor: "#0080b8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,61,130,0.08), rgba(0,168,232,0.05))",
    numBg: "rgba(0,61,130,0.10)",
    numColor: "#003d82",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,168,232,0.09), rgba(255,214,0,0.06))",
    numBg: "rgba(0,168,232,0.12)",
    numColor: "#0080b8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(13,71,161,0.08), rgba(0,168,232,0.06))",
    numBg: "rgba(13,71,161,0.10)",
    numColor: "#0d47a1",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,200,150,0.09), rgba(0,168,232,0.06))",
    numBg: "rgba(0,200,150,0.12)",
    numColor: "#009a72",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,115,232,0.08), rgba(255,107,0,0.06))",
    numBg: "rgba(26,115,232,0.10)",
    numColor: "#1a73e8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(233,30,99,0.08), rgba(255,214,0,0.06))",
    numBg: "rgba(233,30,99,0.10)",
    numColor: "#c2185b",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.09), rgba(255,143,0,0.06))",
    numBg: "rgba(46,125,50,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(124,58,237,0.09), rgba(0,245,196,0.06))",
    numBg: "rgba(124,58,237,0.12)",
    numColor: "#7c3aed",
    prompt: `[NotebookLM Slide Design Guide]
...
export const GAME_PROMPTS = [
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,59,124,0.09), rgba(255,214,10,0.06))",
    numBg: "rgba(255,59,124,0.12)",
    numColor: "#cc0055",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,229,255,0.09), rgba(255,107,53,0.06))",
    numBg: "rgba(0,229,255,0.12)",
    numColor: "#00a8c4",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(108,99,255,0.09), rgba(255,255,255,0.8))",
    numBg: "rgba(108,99,255,0.12)",
    numColor: "#6c63ff",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 건설사 전용 7개 디자인 프롬프트 ─────────────────────────
export const CONSTRUCTION_PROMPTS = [
  {
    name: "프레스티지 시행사 IR",
    type: "Prestige Developer IR",
    colors: ["#0a1628", "#c9a84c", "#f5f5f0"],
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.10), rgba(10,22,40,0.06))",
    numBg: "rgba(201,168,76,0.14)",
    numColor: "#9a7a20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,26,110,0.08), rgba(201,168,76,0.06))",
    numBg: "rgba(0,26,110,0.10)",
    numColor: "#001a6e",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#fce4ec", "#e91e63", "#1565c0"],
    cardBg:
      "linear-gradient(135deg, rgba(233,30,99,0.07), rgba(252,228,236,0.8))",
    numBg: "rgba(233,30,99,0.10)",
    numColor: "#c2185b",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,214,0,0.09), rgba(255,107,0,0.06))",
    numBg: "rgba(255,214,0,0.12)",
    numColor: "#cc9900",
    prompt: `[NotebookLM Slide Design Guide]
...
export const INTERIOR_PROMPTS = [
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.09), rgba(245,245,245,0.8))",
    numBg: "rgba(29,29,31,0.08)",
    numColor: "#1d1d1f",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(138,154,122,0.08), rgba(250,250,250,0.8))",
    numBg: "rgba(45,45,45,0.07)",
    numColor: "#2d2d2d",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 식당 전용 7개 디자인 프롬프트 ─────────────────────────
export const RESTAURANT_PROMPTS = [
  {
    name: "파인다이닝 블랙",
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(201,120,28,0.09), rgba(250,246,240,0.8))",
    numBg: "rgba(92,58,30,0.10)",
    numColor: "#5c3a1e",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(198,40,40,0.08), rgba(46,125,50,0.06))",
    numBg: "rgba(198,40,40,0.10)",
    numColor: "#c62828",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,107,0,0.08), rgba(245,245,247,0.8))",
    numBg: "rgba(255,107,0,0.12)",
    numColor: "#cc5500",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 카페 전용 7개 디자인 프롬프트 ─────────────────────────
export const CAFE_PROMPTS = [
  {
    name: "아르떼 카페 감성",
    type: "Arte Cafe Aesthetic",
    colors: ["#fdf6e8", "#7a4a00", "#c9a84c"],
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.10), rgba(253,246,232,0.8))",
    numBg: "rgba(122,74,0,0.10)",
    numColor: "#7a4a00",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#f5f5f5", "#1d1d1f", "#c9a84c"],
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.08), rgba(245,245,245,0.8))",
    numBg: "rgba(29,29,31,0.08)",
    numColor: "#1d1d1f",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,200,150,0.09), rgba(26,26,46,0.06))",
    numBg: "rgba(0,200,150,0.12)",
    numColor: "#009a72",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#f5f5f7", "#1d1d1f", "#0071e3"],
    cardBg:
      "linear-gradient(135deg, rgba(0,113,227,0.08), rgba(245,245,247,0.8))",
    numBg: "rgba(0,113,227,0.10)",
    numColor: "#0071e3",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(201,168,76,0.10), rgba(12,12,20,0.06))",
    numBg: "rgba(201,168,76,0.14)",
    numColor: "#9a7a18",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(85,139,47,0.09), rgba(0,87,168,0.06))",
    numBg: "rgba(85,139,47,0.12)",
    numColor: "#4a7a28",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 식품제조 전용 7개 디자인 프롬프트 ─────────────────────────
export const FOODMFG_PROMPTS = [
  {
    name: "프리미엄 식품 브랜딩",
    type: "Premium Food Branding",
    colors: ["#fdf6e8", "#7a4a00", "#c9a227"],
    cardBg:
      "linear-gradient(135deg, rgba(201,162,39,0.10), rgba(253,246,232,0.8))",
    numBg: "rgba(122,74,0,0.10)",
    numColor: "#7a4a00",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,59,48,0.08), rgba(255,214,0,0.06))",
    numBg: "rgba(255,59,48,0.12)",
    numColor: "#cc1a10",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.08), rgba(255,255,255,0.8))",
    numBg: "rgba(46,125,50,0.10)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 편의점 전용 7개 디자인 프롬프트 ─────────────────────────
export const CVS_PROMPTS = [
  {
    name: "24시 에너지",
    type: "24H Convenience Energy",
    colors: ["#0a1628", "#ffd600", "#ff3b30"],
    cardBg:
      "linear-gradient(135deg, rgba(255,214,0,0.09), rgba(255,59,48,0.06))",
    numBg: "rgba(255,214,0,0.14)",
    numColor: "#cc9900",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(226,201,126,0.10), rgba(26,26,46,0.06))",
    numBg: "rgba(226,201,126,0.14)",
    numColor: "#9a7a20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(156,39,176,0.08), rgba(255,64,129,0.06))",
    numBg: "rgba(156,39,176,0.10)",
    numColor: "#7b1fa2",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#fdf6e8", "#7a4a00", "#c9a227"],
    cardBg:
      "linear-gradient(135deg, rgba(201,162,39,0.09), rgba(253,246,232,0.8))",
    numBg: "rgba(122,74,0,0.10)",
    numColor: "#7a4a00",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(230,57,70,0.08), rgba(255,240,240,0.8))",
    numBg: "rgba(230,57,70,0.12)",
    numColor: "#c42030",
    prompt: `[NotebookLM Slide Design Guide]
...
export const ECOMMERCE_PROMPTS = [
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,107,0,0.09), rgba(255,214,0,0.06))",
    numBg: "rgba(255,107,0,0.12)",
    numColor: "#cc5500",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,59,124,0.09), rgba(255,214,0,0.06))",
    numBg: "rgba(255,59,124,0.12)",
    numColor: "#cc0055",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(124,58,237,0.08), rgba(0,200,150,0.06))",
    numBg: "rgba(124,58,237,0.10)",
    numColor: "#7c3aed",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,149,0,0.09), rgba(244,244,244,0.8))",
    numBg: "rgba(255,149,0,0.12)",
    numColor: "#cc7700",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(68,136,255,0.09), rgba(255,214,0,0.06))",
    numBg: "rgba(68,136,255,0.12)",
    numColor: "#2266cc",
    prompt: `[NotebookLM Slide Design Guide]
...
export const FRANCHISE_PROMPTS = [
  {
    name: "프랜차이즈 IR 피치",
    type: "Franchise IR Pitch",
    colors: ["#ffffff", "#1d1d1f", "#ff6b00"],
    cardBg:
      "linear-gradient(135deg, rgba(255,107,0,0.08), rgba(255,255,255,0.8))",
    numBg: "rgba(255,107,0,0.12)",
    numColor: "#cc5500",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(212,175,55,0.10), rgba(10,10,20,0.06))",
    numBg: "rgba(212,175,55,0.14)",
    numColor: "#9a7a18",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,102,204,0.08), rgba(244,244,244,0.8))",
    numBg: "rgba(0,102,204,0.10)",
    numColor: "#0066cc",
    prompt: `[NotebookLM Slide Design Guide]
...
export const INSURANCE_PROMPTS = [
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,61,130,0.08), rgba(52,199,89,0.06))",
    numBg: "rgba(0,61,130,0.10)",
    numColor: "#003d82",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,58,108,0.08), rgba(255,107,0,0.06))",
    numBg: "rgba(255,107,0,0.12)",
    numColor: "#cc5500",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(141,110,99,0.08), rgba(21,101,192,0.06))",
    numBg: "rgba(141,110,99,0.10)",
    numColor: "#6d4c41",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(98,0,234,0.08), rgba(0,200,150,0.06))",
    numBg: "rgba(98,0,234,0.10)",
    numColor: "#6200ea",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,115,232,0.08), rgba(255,107,53,0.06))",
    numBg: "rgba(26,115,232,0.10)",
    numColor: "#1a73e8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(247,147,26,0.09), rgba(98,126,234,0.07))",
    numBg: "rgba(247,147,26,0.12)",
    numColor: "#c06c00",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(21,101,192,0.08), rgba(0,200,150,0.06))",
    numBg: "rgba(21,101,192,0.10)",
    numColor: "#1565c0",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 학원 전용 7개 디자인 프롬프트 ─────────────────────────
export const ACADEMY_PROMPTS = [
  {
    name: "합격 드라이브",
    type: "Achievement Drive",
    colors: ["#fff8f0", "#ff6b00", "#1a3a8a"],
    cardBg:
      "linear-gradient(135deg, rgba(255,107,0,0.08), rgba(26,58,138,0.06))",
    numBg: "rgba(255,107,0,0.12)",
    numColor: "#cc5500",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(201,162,39,0.08), rgba(12,12,12,0.05))",
    numBg: "rgba(201,162,39,0.12)",
    numColor: "#9a7a10",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,255,136,0.07), rgba(77,148,255,0.06))",
    numBg: "rgba(0,255,136,0.10)",
    numColor: "#00cc66",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 유치원 전용 7개 디자인 프롬프트 ─────────────────────────
export const KINDERGARTEN_PROMPTS = [
  {
    name: "무지개 킨더가든",
    type: "Rainbow Kindergarten Joy",
    colors: ["#fffde7", "#ff9800", "#e91e63"],
    cardBg:
      "linear-gradient(135deg, rgba(255,152,0,0.10), rgba(233,30,99,0.07))",
    numBg: "rgba(255,152,0,0.14)",
    numColor: "#e65100",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#f1f8e9", "#2e7d32", "#ff8f00"],
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.10), rgba(255,143,0,0.07))",
    numBg: "rgba(46,125,50,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(141,110,99,0.08), rgba(129,199,132,0.07))",
    numBg: "rgba(141,110,99,0.10)",
    numColor: "#6d4c41",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(21,101,192,0.08), rgba(255,111,0,0.06))",
    numBg: "rgba(21,101,192,0.10)",
    numColor: "#1565c0",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.08), rgba(255,152,0,0.06))",
    numBg: "rgba(46,125,50,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(156,39,176,0.08), rgba(255,214,0,0.07))",
    numBg: "rgba(156,39,176,0.10)",
    numColor: "#6a1b9a",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 대학 전용 7개 디자인 프롬프트 ─────────────────────────
export const UNIVERSITY_PROMPTS = [
  {
    name: "대학 입학 브로슈어",
    type: "University Admissions Brochure",
    colors: ["#001a6e", "#ffffff", "#ffd600"],
    cardBg:
      "linear-gradient(135deg, rgba(0,26,110,0.08), rgba(255,214,0,0.06))",
    numBg: "rgba(0,26,110,0.10)",
    numColor: "#001a6e",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#e8f5e9", "#2e7d32", "#1565c0"],
    cardBg:
      "linear-gradient(135deg, rgba(46,125,50,0.08), rgba(21,101,192,0.06))",
    numBg: "rgba(46,125,50,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(232,197,71,0.08), rgba(26,26,46,0.05))",
    numBg: "rgba(232,197,71,0.12)",
    numColor: "#a08a20",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 직업훈련 전용 7개 디자인 프롬프트 ─────────────────────────
export const VOCATIONAL_PROMPTS = [
  {
    name: "취업 성공 드라이브",
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,107,0,0.08), rgba(244,244,244,0.8))",
    numBg: "rgba(255,107,0,0.12)",
    numColor: "#cc5500",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(76,175,80,0.08), rgba(243,243,243,0.8))",
    numBg: "rgba(76,175,80,0.12)",
    numColor: "#2e7d32",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(247,195,37,0.08), rgba(255,107,107,0.06))",
    numBg: "rgba(247,195,37,0.12)",
    numColor: "#c49a00",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,87,168,0.08), rgba(255,214,0,0.06))",
    numBg: "rgba(0,87,168,0.10)",
    numColor: "#0057a8",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 의료기기 전용 7개 디자인 프롬프트 ─────────────────────────
export const MEDDEVICE_PROMPTS = [
  {
    name: "정밀 메드테크",
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(0,87,168,0.08), rgba(0,168,107,0.06))",
    numBg: "rgba(0,87,168,0.10)",
    numColor: "#0057a8",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    colors: ["#0d0d1a", "#7c3aed", "#00e5ff"],
    cardBg:
      "linear-gradient(135deg, rgba(124,58,237,0.08), rgba(0,229,255,0.06))",
    numBg: "rgba(124,58,237,0.12)",
    numColor: "#7c3aed",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(13,71,161,0.08), rgba(245,124,0,0.06))",
    numBg: "rgba(13,71,161,0.10)",
    numColor: "#0d47a1",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(255,149,0,0.08), rgba(245,245,247,0.8))",
    numBg: "rgba(255,149,0,0.12)",
    numColor: "#cc7700",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 철강 전용 7개 디자인 프롬프트 ─────────────────────────
export const STEEL_PROMPTS = [
  {
    name: "스틸 파워",
    type: "Industrial Steel Power",
    colors: ["#1a1a1a", "#c0c0c0", "#ff6b00"],
    cardBg:
      "linear-gradient(135deg, rgba(255,107,0,0.08), rgba(26,26,26,0.05))",
    numBg: "rgba(255,107,0,0.12)",
    numColor: "#cc5500",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(27,94,32,0.08), rgba(0,119,182,0.06))",
    numBg: "rgba(27,94,32,0.12)",
    numColor: "#1b5e20",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(230,57,70,0.06), rgba(245,245,245,0.8))",
    numBg: "rgba(230,57,70,0.10)",
    numColor: "#c42030",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(212,175,55,0.08), rgba(0,18,51,0.05))",
    numBg: "rgba(212,175,55,0.12)",
    numColor: "#8a7200",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(230,81,0,0.07), rgba(255,243,224,0.6))",
    numBg: "rgba(230,81,0,0.12)",
    numColor: "#bf4000",
    prompt: `[NotebookLM Slide Design Guide]
...
// ── 조선 전용 7개 디자인 프롬프트 ─────────────────────────
export const SHIPBUILDING_PROMPTS = [
  {
    name: "딥 오션 블루",
    type: "Deep Ocean Maritime",
    colors: ["#001529", "#0077b6", "#90e0ef"],
    cardBg:
      "linear-gradient(135deg, rgba(0,119,182,0.10), rgba(144,224,239,0.08))",
    numBg: "rgba(0,119,182,0.12)",
    numColor: "#0077b6",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(26,122,74,0.08), rgba(0,119,182,0.06))",
    numBg: "rgba(26,122,74,0.12)",
    numColor: "#1a7a4a",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(79,195,247,0.08), rgba(10,22,40,0.05))",
    numBg: "rgba(79,195,247,0.12)",
    numColor: "#0288d1",
    prompt: `[NotebookLM Slide Design Guide]
...
Apply this style consistently across all slides for a cohesive, professional slides design.`,
  },
  {
    ...
    cardBg:
      "linear-gradient(135deg, rgba(230,81,0,0.07), rgba(255,248,225,0.5))",
    numBg: "rgba(230,81,0,0.12)",
    numColor: "#bf4000",
    prompt: `[NotebookLM Slide Design Guide]
